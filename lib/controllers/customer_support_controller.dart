...
class CustomerSupportController extends GetxController {
    ...
    await global.checkBody().then((result) async {
      if (result) {
        await apiHelper.deleteTicket().then((result) async {
          if (result.status == "200") {
            global.showToast(message: 'Deleted Successfully', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            await getCustomerTickets();
          } else {
            global.showToast(message: 'Fail Delete', textColor: global.textColor, bgColor: global.toastBackGoundColor);
          }
        });
      }
    });
      ...
      if (result) {
        await apiHelper.deleteOneTicket(ticketId).then((result) async {
          if (result.status == "200") {
            ...
            global.showToast(message: 'Delete Failed', textColor: global.textColor, bgColor: global.toastBackGoundColor);
          }
        });
      }
    });
        ...
        if (result) {
          await apiHelper.getHelpAndSupport().then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'customer help and support', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getHelpAndSupportQuestion(helpSupportId).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'customer help and support getHelpAndSupportQuestion', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getHelpAndSupportQuestionAnswer(helpSupportId).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'customer help and support getHelpAndSupportQuestionAnswer', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.restratCustomerSupportChat(id).then((result) async {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail customer help and support', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
  ...
  createCustomerTickets(String subject, int helpSupportQuestionId, String helpSupportQuestion, String helpSupportSubQuestion) async {
    try {
      await global.checkBody().then((result) async {
        if (result) {
          CustomerSuppportModel customerSuppportModel = CustomerSuppportModel(userId: global.currentUserId!, subject: subject, description: descriptionController.text, helpSupportId: helpSupportQuestionId);
          await apiHelper.creaetTicket(customerSuppportModel).then((result) async {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Ticket created successfully!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              descriptionController.clear();
            } else {
              global.showToast(message: 'failed created ticket', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
      ...
      await global.checkBody().then((result) async {
        if (result) {
          await apiHelper.addCustomerSupportReview(reviewController.text, rating, ticketId).then((result) async {
            if (result.status == "200") {
              global.showToast(message: 'Review added successfully!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              isAddEdit = false;
              update();
            } else {
              global.showToast(message: 'failed add review please try again later!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
      ...
      await global.checkBody().then((result) async {
        if (result) {
          await apiHelper.editCustomerSupportReview(reviewController.text, rating, ticketId).then((result) async {
            if (result.status == "200") {
              global.showToast(message: 'Review updated successfully!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              isAddEdit = false;
              update();
            } else {
              global.showToast(message: 'failed update review please try again later!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
  ...
  Future<void> sendMessage(String message, String chatId, int partnerId) async {
    try {
      if (message.trim() != '') {
        ChatMessageModel chatMessage = ChatMessageModel(message: message, createdAt: DateTime.now(), updatedAt: DateTime.now(), isDelete: false, isRead: true, userId1: '${global.currentUserId}', userId2: '$partnerId');
        update();
        ...
        if (result) {
          await apiHelper.getTicketStatus().then((result) async {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Get ticket status failed', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
