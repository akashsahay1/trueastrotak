        ...
        if (result) {
          await apiHelper.getHistory(userId, callStart, callFetch).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail to get Call History ', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getHistory(userId, reportStart, reportFetch).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail to get Report History', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getHistory(userId, paymentStart, paymentFetch).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail to get Payment Logs History', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getHistory(userId!, startIndex, fetchRecord).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail to get AstroMall History', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getHistory(userId, walletStart, walletFetch).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail Payment Logs History', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.getCallHistoryById(callId).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Fail Call History by ID', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
        ...
        if (result) {
          await apiHelper.cancelAstromallOrder(id).then((result) async {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Failed to cancel order please try gain later!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
