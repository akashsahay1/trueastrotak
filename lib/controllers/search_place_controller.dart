...
class SearchPlaceController extends GetxController {
  ...
  Future<FindAutocompletePredictionsResponse> _getPredictions(String value) async {
    if (kIsWeb) {
      // Return hardcoded data for web
      return _getHardcodedPredictions();
    } else {
      // Use Google Places SDK for other platforms
      return await placesSdk!.findAutocompletePredictions(value, newSessionToken: false);
    }
  }
  ...
  Future<FindAutocompletePredictionsResponse> _getHardcodedPredictions() async {
    ...
    List<AutocompletePrediction> hardcodedPredictions = [
      AutocompletePrediction(primaryText: "New York City", secondaryText: "NY, USA", placeId: "ChIJOwg_06VPwokRYv534QaPC8g", distanceMeters: 12, fullText: 'oyeahh 1'),
      AutocompletePrediction(primaryText: "Los Angeles", secondaryText: "CA, USA", placeId: "ChIJE9on3F3HwoAR9AhGJW_fL-I", distanceMeters: 12, fullText: 'oyeahh 2'),
    ];
    return FindAutocompletePredictionsResponse(hardcodedPredictions);
  }
}
