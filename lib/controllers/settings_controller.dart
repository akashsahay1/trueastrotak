          ...
          await apiHelper.getNotifications().then((result) {
            if (result.status == "200") {
              ...
              if (global.currentUserId != null) {
                global.showToast(message: 'Fail to et Notifications', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              }
            }
          });
        }
        ...
        if (result) {
          await apiHelper.deleteNotifications(id).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'delete Notification successfully', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            } else {
              if (global.currentUserId != null) {
                global.showToast(message: 'Fail delete Notifications', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              }
            }
          });
        }
        ...
        if (result) {
          await apiHelper.deleteAllNotifications().then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'Delete all Notification successfully', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            } else {
              if (global.currentUserId != null) {
                global.showToast(message: 'Fail delete Notifications', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              }
        ...
        if (result) {
          await apiHelper.getBlockAstrologer().then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'FAil to get block Atrologer', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
      ...
      await global.checkBody().then((result) async {
        if (result) {
          await apiHelper.unblockAstrologer(astrologerId).then((result) async {
            if (result.status == "200") {
              global.showToast(message: 'Astrologer Unblocked!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              await getBlockAstrologerList();
              BottomNavigationController bottomNavigationController = Get.find<BottomNavigationController>();
              await bottomNavigationController.getAstrologerbyId(astrologerId);
              bottomNavigationController.update();
            } else {
              global.showToast(message: 'Fail get block Atrologer', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
