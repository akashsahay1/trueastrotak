    ...
    try {
      await apiHelper.saveChattingTime(seconds, chatIdd).then((result) {
        if (result.status == "200") {
          ...
          global.showToast(message: 'Chat ended..', textColor: global.textColor, bgColor: global.toastBackGoundColor);
        } else {
          global.showToast(message: 'chat not ended', textColor: global.textColor, bgColor: global.toastBackGoundColor);
        }
      });
