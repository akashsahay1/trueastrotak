          ...
          await apiHelper.getUpcomingList().then((result) {
            if (result.status == "200") {
              ...
              if (global.currentUserId != null) {
                global.showToast(message: 'Fail to get Live Event', textColor: global.textColor, bgColor: global.toastBackGoundColor);
              }
            }
          });
        }
        ...
        if (result) {
          await apiHelper.liveEventSearch(searchString).then((result) {
            if (result.status == "200") {
              ...
              global.showToast(message: 'failed to search event', textColor: global.textColor, bgColor: global.toastBackGoundColor);
            }
          });
        }
      });
