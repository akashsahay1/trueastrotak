...
class Rating {
  Rating({this.oneStarRating, this.twoStarRating, this.threeStarRating, this.fourStarRating, this.fiveStarRating});
  ...
  Map<String, dynamic> toMap() => {"oneStarRating": oneStarRating ?? 0, "twoStarRating": twoStarRating ?? 0, "threeStarRating": threeStarRating ?? 0, "fourStarRating": fourStarRating ?? 0, "fiveStarRating": fiveStarRating ?? 0};
}
...
class SimiliarConsultant {
  ...
  SimiliarConsultant({this.profileImage, this.name, this.charge, this.primarySkill, this.id});

  factory SimiliarConsultant.fromJson(Map<String, dynamic> json) => SimiliarConsultant(profileImage: json["profileImage"] ?? "", name: json["name"] ?? "", charge: json["charge"] ?? 0, primarySkill: json["primarySkill"] ?? "", id: json["id"]);

  Map<String, dynamic> toJson() => {"profileImage": profileImage, "name": name, "charge": charge, "primarySkill": primarySkill, "id": id};
}
