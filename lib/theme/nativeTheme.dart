...
ThemeData nativeTheme({bool? darkModeEnabled}) {
  ...
  if (darkModeEnabled) {
    ...
    return ThemeData(
      appBarTheme: AppBarTheme(systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: themeController.pickColor, statusBarIconBrightness: Brightness.light)),
      fontFamily: 'Poppins',
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(style: ButtonStyle(backgroundColor: WidgetStateProperty.all(themeController.pickColor), foregroundColor: WidgetStateProperty.all(const Color(0xFFF5F5F5)))),
      colorScheme: ColorScheme.fromSwatch(primarySwatch: MaterialColor(themeController.pickColorInt, color)),
    );
  }
}
