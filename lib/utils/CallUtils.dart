...
class CallUtils {
  static Future<void> showIncomingCall(var body) async {
    ...
    CallKitParams callKitParams = CallKitParams(
      ...
      handle: 'True Astrotalk Partner',
      type: calltype ? 0 : 1, // 0 for audio call, 1 for video call
      textAccept: 'Accept',
      textDecline: 'Decline',
      duration: 30000,
      missedCallNotification: const NotificationParams(showNotification: true, isShowCallback: true, subtitle: 'Missed call', callbackText: 'Call back'),
