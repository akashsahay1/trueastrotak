...
import 'package:trueastrotalk/model/astrologer_availability_model.dart';
...
import 'package:trueastrotalk/model/dailyHoroscope_model.dart';
...
import 'package:trueastrotalk/model/language.dart';
import 'package:trueastrotalk/model/languageModel.dart';
...
import 'package:trueastrotalk/model/remote_host_model.dart';
...
import 'package:trueastrotalk/model/wait_list_model.dart';
import 'package:trueastrotalk/utils/global.dart';
import 'package:trueastrotalk/utils/services/api_result.dart';
...
class APIHelper {
  ...
  Future<dynamic> checkContact(String phoneno) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/checkContactNoExistForUser'), headers: await global.getApiHeaders(false), body: json.encode({"contactNo": phoneno}));
      dynamic recordList;
  ...
  Future<dynamic> validateSession() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/validateSession"), headers: await global.getApiHeaders(true));
  ...
  Future<dynamic> getHororscopeSign() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getHororscopeSign"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getCurrentUser() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getProfile"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getKundli() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getkundali"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getPdfKundli(String id) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/kundali/get/$id"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getPdfPrice() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/pdf/price"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = response.body;
      } else {
  ...
  Future<dynamic> getAppReview() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/appReview/get"), headers: await global.getApiHeaders(true), body: json.encode({"appId": 1}));
      dynamic recordList;
      log("${response.statusCode}");
      log("${response.body}");
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getAllStory() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAstrologerStory"), headers: await global.getApiHeaders(true));
      log("getAstrologerStory");
      log("${response.statusCode}");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AllStories>.from(json.decode(response.body)["recordList"].map((x) => AllStories.fromJson(x)));
      } else {
        recordList = null;
      }
      return getAPIResult(response, recordList);
  ...
  Future<dynamic> getAstroStory(String astrologerId) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getStory"), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": astrologerId}));
      print("viewSigleStory");
      print("${response.statusCode}");
      print("${jsonDecode(response.body)}");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<ViewStories>.from(json.decode(response.body)["recordList"].map((x) => ViewStories.fromJson(x)));
      } else {
        recordList = null;
      }
      return getAPIResult(response, recordList);
  ...
  Future<dynamic> storyViewed(String storyId) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/clickStory"), headers: await global.getApiHeaders(true), body: json.encode({"storyId": storyId}));
      print("viewStory");
  ...
  Future<dynamic> getAstrologer({int? catId, String? sortingKey, List<int>? skills, List<int>? language, List<String>? gender, int? startIndex, int? fetchRecords}) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/getAstrologer'),
  ...
  Future<dynamic> checkUserAlreadyInChatReq({int? astorlogerId}) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/checkChatSessionAvailable'), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": astorlogerId}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> checkUserAlreadyInCallReq({int? astorlogerId}) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/checkCallSessionAvailable'), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": astorlogerId}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)["recordList"];
      } else {
  ...
  Future<dynamic> getWaitList(String channel) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/waitlist/get'), body: {"channelName": channel});
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> deleteFromWishList(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/waitlist/delete'), body: {"id": id.toString()});
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> updateStatusForWaitList({int? id, String? status}) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/waitlist/updateStatus'), body: {"id": id.toString(), "status": "$status"});
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> getSkill() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getSkill'), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getLanguage() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getLanguage'));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getAstromallCategory(int startIndex, int fetchRecord) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getproductCategory"), headers: await global.getApiHeaders(true), body: json.encode({"startIndex": startIndex, "fetchRecord": fetchRecord}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getAstromallProduct(int id, int startIndex, int fetchRecord) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAstromallProduct"), headers: await global.getApiHeaders(true), body: json.encode({"productCategoryId": "$id", "startIndex": startIndex, "fetchRecord": fetchRecord}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getProductById(int id) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAstromallProductById"), headers: await global.getApiHeaders(false), body: json.encode({"id": "$id"}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstromallProductModel>.from(json.decode(response.body)["recordList"].map((x) => AstromallProductModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> cancelAstromallOrder(int id) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/userOrder/cancel"), headers: await global.getApiHeaders(true), body: json.encode({"id": "$id"}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getGift() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getGift"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getUserAddress(int id) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getOrderAddress"), headers: await global.getApiHeaders(true), body: json.encode({"userId": "$id"}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getKundliById(int id) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/Kundali/show/$id"));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<KundliModel>.from(json.decode(response.body)["recordList"].map((x) => KundliModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> getReview(int id) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAstrologerUserReview"), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": "$id"}));
      log("reviews");
  ...
  Future<dynamic> getAstrologerCategory() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/activeAstrologerCategory"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getReportType(String? searchString, int startIndex, int fetchRecord) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getReportType"), headers: await global.getApiHeaders(true), body: json.encode({"searchString": searchString, "startIndex": startIndex, "fetchRecord": fetchRecord}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getCounsellors(int startIndex, int fetchRecord) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getCounsellor"), headers: await global.getApiHeaders(false), body: json.encode({"startIndex": startIndex, "fetchRecord": fetchRecord, "userId": global.user.id}));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getFollowedAstrologer(int startIndex, int record) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getFollower"), headers: await global.getApiHeaders(true), body: json.encode({"startIndex": startIndex, "fetchRecord": record}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstrologerModel>.from(json.decode(response.body)["recordList"].map((x) => AstrologerModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> getLiveAstrologer() async {
    try {
      final response = await http.post(headers: await global.getApiHeaders(true), Uri.parse("$baseUrl/liveAstrologer/get"));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> setRemoteId(int astroId, int remoteId) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/addAstrohost"), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": "$astroId", "hostId": "$remoteId"}));
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> getRemoteId(int astroId) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAstrohost"), body: {"astrologerId": astroId.toString()});
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  //add API
  Future<dynamic> addKundli(List<KundliModel> basicDetails, int amount, bool isMatch) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/kundali/add'), headers: await global.getApiHeaders(true), body: json.encode({"kundali": basicDetails, "amount": amount, "is_match": isMatch}));
      log("ajksnkjd");
      log("${json.encode({"kundali": basicDetails, "amount": amount, "is_match": isMatch})}");
  ...
  Future<dynamic> addPlanetKundli(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/kundali/addForTrackPlanet'), headers: await global.getApiHeaders(true), body: json.encode({"id": id}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> addAddress(UserAddressModel basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/orderAddress/add'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> addAppFeedback(var basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/appReview/add'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> followAstrologer(int astrologerId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/follower/add'), headers: await global.getApiHeaders(true), body: json.encode({'astrologerId': '$astrologerId'}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> viewerCount(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/addBlogReader'), headers: await global.getApiHeaders(true), body: json.encode({"blogId": "$id"}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> updateUserProfile(int id, var basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/user/update/$id'), headers: await global.getApiHeaders(true), body: jsonEncode(basicDetails));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> updateKundli(int id, KundliModel basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/kundali/update/$id'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> updateAddress(int id, UserAddressModel basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/orderAddress/update/$id'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> unFollowAstrologer(int astrologerId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/follower/update'), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": "$astrologerId"}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> deleteUser(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/user/delete'), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> deleteKundli(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/kundali/delete'), body: json.encode({"id": "$id"}), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> sendAstrologerCallRequest(int astrologerId, bool isFreeSession, String type, String time) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/callRequest/add'), headers: await global.getApiHeaders(true), body: json.encode({'astrologerId': '$astrologerId', "isFreeSession": isFreeSession, "call_type": type == "Videocall" ? 11 : 10, "call_duration": time}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> sendAstrologerChatRequest(int astrologerId, bool isFreeSession, String time) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/chatRequest/add'), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": astrologerId, "isFreeSession": isFreeSession, "chat_duration": time}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> saveChattingTime(int second, int chatId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/chatRequest/endChat'), headers: await global.getApiHeaders(true), body: json.encode({'chatId': '$chatId', 'totalMin': '$second'}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
      } else {
  ...
  Future<dynamic> addAmountInWallet({required double amount, int? cashback}) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/addpayment'), headers: await global.getApiHeaders(true), body: json.encode({"userId": global.user.id!, 'amount': amount, 'cashback_amount': cashback}));
  ...
  Future<dynamic> getAvailability(int astrologerId) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAstrologerAvailability"), headers: await global.getApiHeaders(false), body: json.encode({"astrologerId": "$astrologerId"}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstrologerAvailibilityModel>.from(json.decode(response.body)["recordList"].map((x) => AstrologerAvailibilityModel.fromJson(x)));
      } else {
        recordList = null;
      }
      return getAPIResult(response, recordList);
  ...
  Future<dynamic> acceptChat(int chatId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/chatRequest/acceptChatRequest'), headers: await global.getApiHeaders(true), body: json.encode({"chatId": chatId}));
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> rejectChat(String cid) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/chatRequest/rejectChatRequest'), headers: await global.getApiHeaders(true), body: json.encode({"chatId": cid}));
  ...
  Future<dynamic> cutPaymentForLiveStream(int userId, int astrologerId, int timeInSecond, String transactionType, String chatId, {String? sId1, String? sId2, String? channelName}) async {
    try {
      final response = await http.post(
        Uri.parse('$baseUrl/chatRequest/endLiveChat'),
        headers: await global.getApiHeaders(true),
        body: json.encode({"userId": userId, "astrologerId": astrologerId, "totalMin": timeInSecond, "transactionType": "$transactionType Live Streaming", "chatId": chatId, "sId": sId1, "sId1": sId2, "channelName": channelName, "callType": "$transactionType"}),
      );
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> rejectCall(int callId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/callRequest/rejectCallRequest'), headers: await global.getApiHeaders(true), body: json.encode({"callId": callId}));
  ...
  Future<dynamic> endCall(int callId, int second, String sId, String sId1) async {
    try {
      final response = await http.post(
        Uri.parse('$baseUrl/callRequest/end'),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "callId": callId,
          "totalMin": "$second",
  ...
  Future<dynamic> getHistory(int userId, int startIndex, int fetchRecord) async {
    try {
      ...
      debugPrint('history url:-  ${json.encode({"userId": userId, "startIndex": startIndex, "fetchRecord": fetchRecord})}');
  ...
  Future<dynamic> getUpcomingList() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/liveAstrologer/getUpcomingAstrologer"), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstrologerModel>.from(json.decode(response.body)["recordList"].map((x) => AstrologerModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> getPanchangVedic(String date) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/get/panchang"), headers: await global.getApiHeaders(true), body: json.encode({"panchangDate": date}));
  ...
  Future<dynamic> getKundliBasicPanchangDetails({int? day, int? month, int? year, int? hour, int? min, double? lat, double? lon, double? tzone}) async {
    try {
      ...
      debugPrint('Exception in getKundliBasicPanchangDetails():' + e.toString());
    }
  }
  ...
  Future<dynamic> searchAstrologer(String filterKey, String searchString, int startIndex, int fetchRecord) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/searchAstro'), headers: await global.getApiHeaders(false), body: json.encode({"filterKey": filterKey, "searchString": searchString, "startIndex": startIndex, "fetchRecord": fetchRecord, "userId": global.user.id}));
  ...
  Future<dynamic> searchProductByCategory(int productCategoryId, String searchString) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/searchAstromallProductCategory'), headers: await global.getApiHeaders(false), body: json.encode({"productCategoryId": "$productCategoryId", "searchString": searchString}));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstromallProductModel>.from(json.decode(response.body)["recordList"].map((x) => AstromallProductModel.fromJson(x)));
  ...
  Future<dynamic> getBlog(String searchString, int startIndex, int fetchRecord) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getAppBlog'), headers: await global.getApiHeaders(false), body: json.encode({"searchString": searchString, "startIndex": startIndex, "fetchRecord": fetchRecord}));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getAstrologerById(int astrologerId, int? userId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getAstrologerForCustomer'), headers: await global.getApiHeaders(false), body: json.encode({"astrologerId": astrologerId, "userId": userId}));
      debugPrint('done : $baseUrl/getAstrologerForCustomer');
      debugPrint('done : ${json.encode({"astrologerId": astrologerId, "userId": userId})}');
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstrologerModel>.from(json.decode(response.body)["recordList"].map((x) => AstrologerModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> addReportIntakeDetail(var basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/userReport/add'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
  ...
  Future<dynamic> addAstrologerReview(int astrologerId, double? rating, String? review, bool isPublic) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/userReview/add'), headers: await global.getApiHeaders(true), body: json.encode({"rating": rating, "review": review, "astrologerId": astrologerId, "isPublic": isPublic}));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> getuserReview(int userId, int astrologerId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getAstrologerUserReview'), body: json.encode({"userId": "$userId", "astrologerId": "$astrologerId"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<ReviewModel>.from(json.decode(response.body)["recordList"].map((x) => ReviewModel.fromJson(x)));
  ...
  Future<dynamic> updateAstrologerReview(int id, var basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/userReview/update/$id'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> deleteReview(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/userReview/delete/$id'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> getHoroscope({int? horoscopeSignId}) async {
    try {
      ...
      final response = await http.post(Uri.parse("$baseUrl/getDailyHoroscope"), body: json.encode({"horoscopeSignId": horoscopeSignId, 'langcode': global.sp!.getString('currentLanguage') ?? 'en'}), headers: await global.getApiHeaders(true));
  ...
  Future<dynamic> getTickets(int userId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getTicket'), body: json.encode({"userId": "$userId"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> deleteTicket() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/deleteAll'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> deleteOneTicket(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/delete'), body: json.encode({"id": "$id"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> getHelpAndSupport() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getHelpSupport'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getHelpAndSupportQuestion(int helpSupportId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getHelpSupportQuestion'), headers: await global.getApiHeaders(true), body: json.encode({'helpSupportId': '$helpSupportId'}));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getHelpAndSupportQuestionAnswer(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getHelpSupportSubSubCategory'), headers: await global.getApiHeaders(false), body: json.encode({'helpSupportQuationId': '$id'}));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      ...
      debugPrint("Exception in getHelpAndSupportQuestionAnswer : -" + e.toString());
    }
  }

  Future<dynamic> addCustomerSupportReview(String review, double rating, int ticketId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/addReview'), headers: await global.getApiHeaders(true), body: json.encode({"review": "$review", "rating": "$rating", "ticketId": "$ticketId"}));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> editCustomerSupportReview(String review, double rating, int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/updateReview'), headers: await global.getApiHeaders(true), body: json.encode({"review": "$review", "rating": "$rating", "id": "$id"}));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> getCustomerSupportReview(int ticketId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/getReview'), headers: await global.getApiHeaders(true), body: json.encode({"ticketId": "$ticketId"}));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getTicketStatus() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/checkOpenTicket'), headers: await global.getApiHeaders(true));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> creaetTicket(CustomerSuppportModel basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/add'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> restratCustomerSupportChat(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/ticket/restart'), body: json.encode({"id": "$id"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> sendGiftToAstrologer(int giftId, int astrologerId) async {
    ...
    try {
      final response = await http.post(Uri.parse('$baseUrl/sendGift'), headers: await global.getApiHeaders(true), body: json.encode({"giftId": "$giftId", "astrologerId": "$astrologerId"}));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> getNotifications() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getUserNotification'), headers: await global.getApiHeaders(true));
      dynamic recordList;
  ...
  Future<dynamic> deleteNotifications(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/userNotification/deleteUserNotification'), body: json.encode({"id": "$id"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> deleteAllNotifications() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/userNotification/deleteAllNotification'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> reportAndBlockAstrologer(int astrologerId, String reason) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/reportBlockAstrologer'), body: json.encode({"astrologerId": "$astrologerId", "reason": "$reason"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> unblockAstrologer(int astrologerId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/unBlockAstrologer'), body: json.encode({"astrologerId": "$astrologerId"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> getBlockAstrologer() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getBlockAstrologer'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> agoraStartCloudRecording(String cname, int localUid, String token) async {
      ...
      final response = await http.post(
        ...
        body: json.encode({
          ...
          "clientRequest": {
            "token": "$token",
            "storageConfig": {
              "secretKey": "${global.getSystemFlagValue(global.systemFlagNameList.AWSSecretKey)}",
              "vendor": 1,
              "region": 14,
              "bucket": "${global.getSystemFlagValue(global.systemFlagNameList.AWSBucket)}",
              "accessKey": "${global.getSystemFlagValue(global.systemFlagNameList.AWSAccessKey)}",
            },
            "recordingConfig": {
              "channelType": 0, //
              "streamTypes": 0, //audio 0 video 1 and both 2
              "audioProfile": 1, //SPEECH_STANDARD(1): A sampling rate of 32 kHz, audio encoding, mono, and a bitrate of up to 18 Kbps.
            },
          },
        }),
      );
  ...
  Future<dynamic> stopRecoedingStoreData(int callId, String channelName, String sId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/storeCallRecording'), body: json.encode({"callId": "$callId", "channelName": "$channelName", "sId": "$sId"}), headers: await global.getApiHeaders(true));
  ...
  Future<dynamic> addIntakeDetail(IntakeModel basicDetails) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/chatRequest/addIntakeForm'), headers: await global.getApiHeaders(true), body: json.encode(basicDetails));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body)['recordList'];
  ...
  Future<dynamic> getIntakedata() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/chatRequest/getIntakeForm'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = response.body;
  ...
  Future<dynamic> saveLiveUsers(LiveUserModel details) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/addLiveUser'), body: json.encode(details), headers: await global.getApiHeaders(true));
  ...
  Future<dynamic> getLiveUsers(String channelName) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getLiveUser'), body: json.encode({"channelName": "$channelName"}), headers: await global.getApiHeaders(false));
  ...
  Future<dynamic> deleteLiveUsers() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/deleteLiveUser'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> storeAssistantFirebaseChatId(int userId, int partnerId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getAssistantChatId'), headers: await global.getApiHeaders(true), body: json.encode({"customerId": userId, "astrologerId": partnerId, "senderId": userId, "receiverId": partnerId}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
      ...
      debugPrint('Exception: - storeAssistantFirebaseChatId(): ' + e.toString());
    }
  }

  Future<dynamic> getAssistantChat() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getAssistantChatHistory'), headers: await global.getApiHeaders(true));
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> deleteAssistantChat(int id) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/deleteAssistantChat'), headers: await global.getApiHeaders(true), body: json.encode({"id": id.toString()}));
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
        recordList = null;
  ...
  Future<dynamic> checkAstrologerPaidSession(int astrologerId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getCustomerPaidSession'), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": "$astrologerId"}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> blockAstrologerAssistant(int assistantId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/astrologerAssistant/block'), body: json.encode({"assistantId": "$assistantId"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> unblockAstrologerAssistant(int assistantId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/astrologerAssistant/unBlock'), body: json.encode({"assistantId": "$assistantId"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> liveEventSearch(String? searchString) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/searchLiveAstro"), headers: await global.getApiHeaders(true), body: json.encode({"searchString": searchString}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = List<AstrologerModel>.from(json.decode(response.body)["recordList"].map((x) => AstrologerModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> blockAstrologerProfileReview(int id, int? isBlocked, int? isReported) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/blockUserReview'), body: json.encode({"id": "$id", "isBlocked": isBlocked, "isReported": isReported}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      ...
      debugPrint("Exception in blockAstrologerProfileReview : -" + e.toString());
    }
  }
  ...
  Future<dynamic> changeStatus({int? astrologerId, String? status}) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/addStatus"), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": astrologerId, "status": status, "waitTime": null}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> changeCallStatus({int? astrologerId, String? status}) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/addCallStatus"), headers: await global.getApiHeaders(true), body: json.encode({"astrologerId": astrologerId, "status": status, "waitTime": null}));
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
      } else {
  ...
  Future<dynamic> getCallHistoryById(int callId) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/getCallById'), headers: await global.getApiHeaders(true), body: json.encode({"callId": callId}));
      log("aasndnsd");
  ...
  Future<dynamic> updetUserProfilePic(String profile) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/user/updateProfile'), headers: await global.getApiHeaders(true), body: json.encode({"profile": '$profile'}));
      debugPrint("$response");
      dynamic recordList;
      if (response.statusCode == 200) {
      } else {
  ...
  Future<dynamic> generateRtmToken(String agoraAppId, String agoraAppCertificate, String chatId, String channelName) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/generateToken'), body: json.encode({"appID": "$agoraAppId", "appCertificate": "$agoraAppCertificate", "user": "$chatId", "channelName": "$channelName"}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
  ...
  Future endLiveSession(int astrologerId) async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/liveAstrologer/endSession"), body: {"astrologerId": "$astrologerId"});
      ...
      debugPrint("Exception: api_helper.dart - endLiveSession(): " + e.toString());
    }
  }

  Future getZodiacProfileImg() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getUserProfile"));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      ...
      debugPrint("Exception: api_helper.dart - getZodiacProfileImg(): " + e.toString());
    }
  }

  Future getSystemFlag() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getSystemFlag"));
      ...
      debugPrint("Exception: api_helper.dart - getSystemFlag(): " + e.toString());
    }
  }

  Future getLanguagesForMultiLanguage() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getAppLanguage"));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
      ...
      debugPrint("Exception: api_helper.dart - getLanguagesForMultiLanguage(): " + e.toString());
    }
  }

  Future getpaymentAmount() async {
    try {
      final response = await http.post(Uri.parse("$baseUrl/getRechargeAmount"));
      debugPrint('asd $baseUrl/getRechargeAmount'); //! error when no money in wallet still want to connect to guru add dialog to show no money and recharge
      ...
      debugPrint("Exception: api_helper.dart - getpaymentAmount(): " + e.toString());
    }
  }

  Future<dynamic> checkFreeSession() async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/checkFreeSessionAvailable'), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      debugPrint('done : ${response.statusCode}');
  ...
  Future<dynamic> addFeedBack(String feedbackType, String? feedback) async {
    try {
      final response = await http.post(Uri.parse('$baseUrl/addHoroscopeFeedback'), body: json.encode({"feedbacktype": "$feedbackType", "feedback": feedback}), headers: await global.getApiHeaders(true));
      debugPrint('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.decode(response.body);
