    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Astrology Blog', style: Get.theme.primaryTextTheme.titleLarge!.copyWith(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.white)).tr(),
          leading: IconButton(
            onPressed: () => Get.back(),
            icon: Icon(
              kIsWeb
                            ...
                            children: [
                                    ...
                                    child:
                                        blogController.astrologyBlogs[index].blogImage == ""
                                            ...
                                            : CachedNetworkImage(
                                              ...
                                              imageBuilder: (context, imageProvider) => Image.network("${global.imgBaseurl}${blogController.astrologyBlogs[index].blogImage}", height: 180, width: MediaQuery.of(context).size.width, fit: BoxFit.fill),
                                              placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                  ...
                                  Positioned(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: Row(
                                        ...
                                        children: [const Icon(Icons.visibility, size: 20, color: Colors.black), Padding(padding: EdgeInsets.only(left: 5.0), child: Text("${blogController.astrologyBlogs[index].viewer}", style: TextStyle(fontSize: 12, color: Colors.black)))],
                                      ),
                                    ),
                                  ),
                                ],
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(blogController.astrologyBlogs[index].title, style: Theme.of(context).primaryTextTheme.bodyLarge, textAlign: TextAlign.start).tr(),
                                    Padding(
                                      padding: const EdgeInsets.only(top: 8, bottom: 8),
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text(blogController.astrologyBlogs[index].author, style: Theme.of(context).primaryTextTheme.titleSmall).tr(),
                                          Text("${DateFormat("MMM d,yyyy").format(DateTime.parse(blogController.astrologyBlogs[index].createdAt))}", style: Theme.of(context).primaryTextTheme.titleSmall),
                                        ],
                                      ),
                                    ),
                                  ],
