            ...
            title: GetBuilder<BlogController>(
              builder: (blogcontroller) {
                return FutureBuilder(
                  future: global.showDecorationHint(hint: 'Search by Blog Title', inputBorder: OutlineInputBorder(borderSide: BorderSide.none)),
              ...
              GetBuilder<BlogController>(
                builder: (blogController) {
                  return IconButton(
                    ...
                    icon: Icon(Icons.search, color: Get.theme.iconTheme.color),
                  );
                },
              ),
            ],
          ...
          body: GetBuilder<BlogController>(
            builder: (blogController) {
              return blogController.astrologySearchBlogs.isEmpty
                  ? Center(child: Text('Blogs not found').tr())
                  : ListView.builder(
                                ...
                                children: [
                                      ...
                                      ClipRRect(
                                        ...
                                        child:
                                            blogController.astrologySearchBlogs[index].blogImage == ""
                                                ? Image.asset(Images.blog, height: 180, width: MediaQuery.of(context).size.width, fit: BoxFit.fill)
                                                ...
                                                ? Stack(
                                                  ...
                                                  children: [
                                                    CachedNetworkImage(
                                                      ...
                                                      imageBuilder: (context, imageProvider) => Container(height: 180, width: Get.width, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), image: DecorationImage(fit: BoxFit.fill, image: imageProvider))),
                                                      placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                                      errorWidget: (context, url, error) => Image.asset(Images.blog, height: 180, width: Get.width, fit: BoxFit.fill),
                                                    ),
                                                ...
                                                : CachedNetworkImage(
                                                  ...
                                                  imageBuilder: (context, imageProvider) => Image.network("${global.imgBaseurl}${blogController.astrologySearchBlogs[index].blogImage}", height: 180, width: MediaQuery.of(context).size.width, fit: BoxFit.fill),
                                                  placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                                  errorWidget: (context, url, error) => Image.asset(Images.blog, height: 180, width: MediaQuery.of(context).size.width, fit: BoxFit.fill),
                                                ),
                                      ),
                                      Positioned(
                                        right: 8,
                                        child: ElevatedButton(
                                          ...
                                          child: Row(
                                            ...
                                            children: [const Icon(Icons.visibility, size: 20, color: Colors.black), Padding(padding: EdgeInsets.only(left: 5.0), child: Text("${blogController.astrologySearchBlogs[index].viewer}", style: TextStyle(fontSize: 12, color: Colors.black)))],
                                          ),
                                        ),
                                      ),
                                    ],
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(blogController.astrologySearchBlogs[index].title, style: Theme.of(context).primaryTextTheme.bodyLarge, textAlign: TextAlign.start),
                                        Padding(
                                          padding: const EdgeInsets.only(top: 8, bottom: 8),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text(blogController.astrologySearchBlogs[index].author, style: Theme.of(context).primaryTextTheme.titleSmall),
                                              Text("${DateFormat("MMM d,yyyy").format(DateTime.parse(blogController.astrologySearchBlogs[index].createdAt))}", style: Theme.of(context).primaryTextTheme.titleSmall),
                                            ],
                                          ),
                                        ),
                                      ],
