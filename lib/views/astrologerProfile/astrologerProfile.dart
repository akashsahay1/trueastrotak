...
import 'package:trueastrotalk/views/astrologerProfile/availabilityScreen.dart';
import 'package:trueastrotalk/views/astrologerProfile/chat_with_assistant_screen.dart';
...
import 'package:trueastrotalk/widget/showReviewWidget.dart';
...
class _AstrologerProfileState extends State<AstrologerProfile> {
  ...
  Future<void> dialogForJoinInWaitList(context, String astrologerName, bool forChat, String status) async {
    showDialog(
      context: context,
      builder: (context) {
        return SimpleDialog(
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Profile', style: Get.theme.primaryTextTheme.titleLarge!.copyWith(fontSize: 18, fontWeight: FontWeight.normal, color: Colors.white)).tr(),
          leading: IconButton(
            onPressed: () {
              Get.back();
            },
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Row(children: [Image.asset(Images.whatsapp, height: 40, width: 40), Padding(padding: const EdgeInsets.only(right: 9), child: Text('Share', style: Get.textTheme.titleMedium!.copyWith(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.white)).tr())]),
                ),
              ),
            ),
          ],
          ...
          child: GetBuilder<BottomNavigationController>(
            builder: (bController) {
              return Column(
                ...
                children: [
                  bottomNavigationController.astrologerbyId[0].isBlock! ? const SizedBox() : SizedBox(height: 10),
                      ...
                      return bottomNavigationController.astrologerbyId[0].isBlock!
                          ? Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text('You have blocked the astrologer', style: TextStyle(color: Colors.white)).tr(),
                                  ...
                                  builder: (settingsController) {
                                    return TextButton(
                                      ...
                                      style: ButtonStyle(
                                        ...
                                        shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10), side: BorderSide(color: Colors.red))),
                                      ),
                                      child: Text('Unblock', style: Get.theme.primaryTextTheme.bodySmall).tr(),
                                    );
                                  },
                                ),
                              ],
                                ...
                                Row(
                                  ...
                                  children: [
                                        ...
                                        Padding(
                                          ...
                                          child: GetBuilder<HomeController>(
                                            builder: (homeController) {
                                              return InkWell(
                                                onTap: () {
                                                  homeController.viewSingleStory.length == 0
                                                      ? null
                                                ...
                                                child: Container(
                                                  height: 70,
                                                  width: 70,
                                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(36), border: Border.all(width: 4, color: homeController.viewSingleStory.length == 0 ? Colors.grey : Get.theme.primaryColor)),
                                                  child: ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      ...
                                                      placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                                      errorWidget: (context, url, error) {
                                                        return CircleAvatar(radius: 35, backgroundColor: Colors.white, child: Image.asset(Images.deafultUser, fit: BoxFit.fill, height: 50));
                                                      },
                                                    ),
                                                  ),
                                                ),
                                        ...
                                        bottomController.astrologerbyId[0].isFollow!
                                            ? Padding(
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: Colors.blue, //Get.theme.primaryColor,
                                                  borderRadius: BorderRadius.circular(15),
                                                ),
                                                child: Text('Following', style: Get.textTheme.bodyMedium!.copyWith(fontSize: 10, color: Colors.white), textAlign: TextAlign.center).tr(),
                                              ),
                                            )
                                            : Padding(
                                              padding: const EdgeInsets.symmetric(vertical: 5),
                                                  ...
                                                  builder: (followAstrologerController) {
                                                    return InkWell(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Text('Follow', style: Get.textTheme.bodyMedium!.copyWith(fontSize: 10, color: Colors.white), textAlign: TextAlign.center).tr(),
                                                      ),
                                                    );
                                                  },
                                                ),
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Row(children: [Text(bottomController.astrologerbyId[0].name!).tr(), SizedBox(width: 10), Image.asset(Images.right, height: 20)]),
                                            bottomController.astrologerbyId[0].primarySkill == "" ? const SizedBox() : Text('${bottomController.astrologerbyId[0].primarySkill!}', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                            bottomController.astrologerbyId[0].currentCity == "" ? const SizedBox() : Text(bottomController.astrologerbyId[0].currentCity!, style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                            bottomController.astrologerbyId[0].languageKnown == "" ? const SizedBox() : Text(bottomController.astrologerbyId[0].languageKnown!, style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                            Text('Experience : ${bottomController.astrologerbyId[0].experienceInYears} Years', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                            Row(
                                              children: [
                                                bottomController.astrologerbyId[0].isFreeAvailable == true ? Text('FREE', style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 12, fontWeight: FontWeight.w500, letterSpacing: 0, color: Color.fromARGB(255, 167, 1, 1))).tr() : const SizedBox(),
                                                SizedBox(width: bottomController.astrologerbyId[0].isFreeAvailable == true ? 10 : 0),
                                                Text(
                                    ...
                                    PopupMenuButton(
                                                  ...
                                                  children: [
                                                    Align(
                                                      ...
                                                      child: GestureDetector(
                                                        ...
                                                        child: Image.asset(Images.closeRound, height: 25, width: 25),
                                                      ),
                                                    ),
                                                    Text('Report & Block', style: TextStyle(fontSize: 18)).tr(),
                                                  ],
                                                ),
                                                content: SizedBox(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      CircleAvatar(
                                                        ...
                                                        child: CircleAvatar(
                                                          ...
                                                          child: CachedNetworkImage(
                                                            imageUrl: "${global.imgBaseurl}${bottomController.astrologerbyId[0].profileImage}",
                                                            imageBuilder: (context, imageProvider) {
                                                              return CircleAvatar(radius: 35, backgroundColor: Colors.white, backgroundImage: imageProvider);
                                                            },
                                                            placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                                            errorWidget: (context, url, error) {
                                                              return CircleAvatar(radius: 35, backgroundColor: Colors.white, child: Image.asset(Images.deafultUser, fit: BoxFit.fill, height: 50));
                                                      ...
                                                      Center(child: Text('${bottomController.astrologerbyId[0].name}', style: TextStyle(fontWeight: FontWeight.bold)).tr()),
                                                      const SizedBox(height: 10),
                                                      Center(child: Text('Reason for blocking*').tr()),
                                                      TextField(
                                                      ...
                                                      ElevatedButton(
                                                        ...
                                                        style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Get.theme.primaryColor), foregroundColor: MaterialStateProperty.all(Colors.black)),
                                                      ),
                                                      Text('*You can unblock the astrologer from settings section.', style: TextStyle(fontSize: 12)).tr(),
                                                    ],
                                                  ),
                                                ),
                                              ),
                                      ...
                                      itemBuilder: (context) => [PopupMenuItem(child: bottomNavigationController.astrologerbyId[0].isBlock! ? Text('Unblock').tr() : Text('Report & Block').tr(), value: bottomNavigationController.astrologerbyId[0].isBlock! ? "unblock" : "block")],
                                    ),
                                  ],
                                ),
                                Divider(thickness: 2),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                          ...
                                          if (isLogin) {
                                            ...
                                            if (charge * 5 <= global.splashController.currentUser!.walletAmount! || bottomNavigationController.astrologerbyId[0].isFreeAvailable == true) {
                                              if (bottomNavigationController.astrologerbyId[0].chatStatus == "Online" || bottomNavigationController.astrologerbyId[0].chatStatus == "Wait Time") {
                                                ...
                                                if (bottomNavigationController.isUserAlreadyInChatReq == false) {
                                                  ...
                                                  await Get.to(
                                                    () => CallIntakeFormScreen(
                                                      ...
                                                      rate: bottomNavigationController.astrologerbyId[0].charge!.toString(),
                                                    ),
                                                  );
                                                  global.hideLoader();
                                                } else {
                                                ...
                                                dialogForJoinInWaitList(context, bottomNavigationController.astrologerbyId[0].name!, true, bottomNavigationController.astrologerbyId[0].chatStatus.toString());
                                              }
                                            } else {
                                              global.showOnlyLoaderDialog(context);
                                        ...
                                        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.chat, color: Colors.grey, size: 18), SizedBox(width: 5), Text("${bottomNavigationController.astrologerbyId[0].chatMin!} Mins")]),
                                      ),
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Row(children: [Icon(Icons.phone, color: Colors.grey, size: 18), SizedBox(width: 5), Text("${bottomNavigationController.astrologerbyId[0].callMin!} mins")]),
                                      ),
                                    ],
                                  ),
                                ),
                        ...
                        child: GetBuilder<UserProfileController>(
                          builder: (userProfileController) {
                            return Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(bottomNavigationController.astrologerbyId[0].loginBio!, maxLines: userProfileController.isShowMore ? null : 2, style: Get.textTheme.titleMedium!.copyWith(fontSize: 14)).tr(),
                                InkWell(
                                  onTap: () {
                                    userProfileController.showMoreText();
                                  },
                                  child: Text(userProfileController.isShowMore ? "Show less" : "..Show More", style: TextStyle(color: Colors.blue)).tr(),
                                ),
                              ],
                            );
                          },
                                ...
                                GestureDetector(
                                  onTap: () {
                                    reviewController.reviewList.isNotEmpty
                                        ...
                                        : global.showToast(message: 'There is no user review available for this astrologer!', textColor: global.textColor, bgColor: global.toastBackGoundColor);
                                  },
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('${bottomNavigationController.astrologerbyId[0].rating!.toStringAsFixed(2)}', style: Get.textTheme.headlineMedium),
                                    ...
                                    Row(children: [Icon(Icons.person, size: 14, color: Colors.grey), SizedBox(width: 5), Text('${bottomNavigationController.astrologerbyId[0].totalOrder!} orders', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, fontSize: 9)).tr()]),
                                  ],
                                ),
                                SizedBox(width: 25),
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('5', style: Get.textTheme.titleMedium),
                                          SizedBox(width: 10),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('4', style: Get.textTheme.titleMedium),
                                          SizedBox(width: 10),
                                          LinearPercentIndicator(
                                            width: 200,
                                            lineHeight: 16,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('3', style: Get.textTheme.titleMedium),
                                          SizedBox(width: 10),
                                          LinearPercentIndicator(
                                            width: 200,
                                            lineHeight: 16,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('2', style: Get.textTheme.titleMedium),
                                          SizedBox(width: 10),
                                          LinearPercentIndicator(
                                            width: 200,
                                            lineHeight: 16,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('1', style: Get.textTheme.titleMedium),
                                          SizedBox(width: 10),
                                          LinearPercentIndicator(
                                            width: 200,
                                            lineHeight: 16,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Text('View All', style: Get.textTheme.bodyMedium!.copyWith(fontSize: 12, color: Colors.grey)).tr(),
                            ),
                          ],
                        ),
                      )
                    ...
                    builder: (controller) {
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ShowReviewWidget(index: index, astologername: bottomNavigationController.astrologerbyId[0].name ?? "Astrologer", astroImage: "${global.imgBaseurl}${bottomController.astrologerbyId[0].profileImage}");
                        },
                      );
                    },
                  ),
                  InkWell(
                    ...
                    child: reviewController.reviewList.isNotEmpty ? Padding(padding: const EdgeInsets.only(left: 6, right: 6), child: Text('See all reviews', style: Get.textTheme.titleMedium!.copyWith(color: Colors.green)).tr()) : SizedBox(),
                  ),
                                      ...
                                      showDialog(
                                        ...
                                        builder: (context) {
                                          return SimpleDialog(
                                            backgroundColor: Colors.white,
                                            children: [
                                              Padding(padding: const EdgeInsets.all(8.0), child: Text('People who spoke to this Consultant, also spoke to these Consultants. You may try them out!', style: Get.textTheme.bodyMedium).tr()),
                                              SizedBox(
                                                width: 80,
                                                child: Align(
                                                  alignment: Alignment.bottomRight,
                                                  child: TextButton(
                                                    ...
                                                    child: Text('Ok').tr(),
                                                    style: ButtonStyle(maximumSize: MaterialStateProperty.all(Size(80, 40)), foregroundColor: MaterialStateProperty.all(Get.theme.primaryColor)),
                                                  ),
                                                ),
                                              ),
                                            ],
                                                      ...
                                                      child: CircleAvatar(
                                                        ...
                                                        child: CircleAvatar(
                                                          ...
                                                          child: CachedNetworkImage(
                                                            ...
                                                            placeholder: (context, url) => const Center(child: CircularProgressIndicator()),
                                                            errorWidget: (context, url, error) {
                                                              return CircleAvatar(radius: 35, backgroundColor: Colors.white, child: Image.asset(Images.deafultUser, fit: BoxFit.fill, height: 40));
                                                            },
                                                          ),
                                                        ),
                                                      ),
                                                    ),
                                                    Text(bottomNavigationController.astrologerbyId[0].similiarConsultant![index].name ?? 'Astrologer', textAlign: TextAlign.center, style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 13, fontWeight: FontWeight.w400, letterSpacing: 0)).tr(),
                                                    Text(
                                      ...
                                      builder: (context) {
                                        return Padding(
                                          ...
                                          child: SimpleDialog(
                                            ...
                                            children: [
                                              Text('You can chat with astrologer\'s assistant only when you have taken a paid session with the atrologer', style: Get.textTheme.bodyMedium).tr(),
                                              Center(
                                                child: SizedBox(
                                                  width: 80,
                                                  child: ElevatedButton(
                                                    ...
                                                    child: Text('Ok').tr(),
                                                    style: ButtonStyle(maximumSize: MaterialStateProperty.all(Size(80, 40)), backgroundColor: MaterialStateProperty.all(Get.theme.primaryColor), foregroundColor: MaterialStateProperty.all(Colors.black)),
                                                  ),
                                                ),
                                              ),
                                            ],
                              ...
                              builder: (bottomController) {
                                return InkWell(
                                  onTap: () async {
                                    ...
                                    global.hideLoader();
                                    Get.to(() => AvailabilityScreen(astrologerName: bottomController.astrologerbyId[0].name!, astrologerProfile: bottomController.astrologerbyId[0].profileImage!));
                                  },
                                ...
                                return InkWell(
                                  onTap: () async {
                                    ...
                                    if (isLogin) {
                                      ...
                                      showModalBottomSheet(
                                        context: context,
                                        shape: RoundedRectangleBorder(side: BorderSide(color: Get.theme.primaryColor), borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
                                        builder: (context) {
                                          return Container(
                                            height: 280,
                                            child: Column(
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                    children: [
                                                      Text('Send ${bottomNavigationController.astrologerbyId[0].name} a Gift').tr(),
                                                      InkWell(
                                                        onTap: () {
                                                          Get.back();
                                                        },
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(giftController.giftList[index].name, style: Get.textTheme.bodyMedium!.copyWith(fontSize: 12)).tr(),
                                                                        Text('${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} ${giftController.giftList[index].amount}', style: Get.textTheme.bodyMedium!.copyWith(fontSize: 10, color: Colors.grey)),
                                                                      ],
                                                                    ),
                                                                  ),
                                                              ],
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Column(
                                                        mainAxisSize: MainAxisSize.min,
                                                        children: [Text('Wallet Balance', style: Get.textTheme.bodyMedium!.copyWith(fontSize: 12)).tr(), Text('${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)}${global.splashController.currentUser?.walletAmount.toString()}')],
                                                      ),
                                                      Container(
                                                        width: 110,
                                                        height: 40,
                                                        child: TextButton(
                                                          child: Text('Recharge', style: TextStyle(fontSize: 10)).tr(),
                                                          style: ButtonStyle(
                                                            ...
                                                            shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10), side: BorderSide(color: Colors.yellow.shade200))),
                                                          ),
                                                          onPressed: () async {
                                                            global.showOnlyLoaderDialog(context);
                                                            await walletController.getAmount();
                                                      ...
                                                      Container(
                                                        ...
                                                        height: 40,
                                                        child: TextButton(
                                                          child: Text('Send Gift', style: TextStyle(fontSize: 10)).tr(),
                                                          style: ButtonStyle(
                                                            padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.all(8)),
                                                            foregroundColor: MaterialStateProperty.all<Color>(Colors.black),
                                ...
                                return bottomNavigationController.astrologerbyId[0].isFollow!
                                    ...
                                    : Card(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Row(children: [Icon(Icons.person_add, color: Colors.grey), SizedBox(width: 20), Text('Follow ${bottomNavigationController.astrologerbyId[0].name}').tr()]),
                                            Text('Follow ${bottomNavigationController.astrologerbyId[0].name} to get notifed when they go live,come online or run an offers!', style: Get.textTheme.bodyMedium!.copyWith(fontSize: 12, color: Colors.grey)).tr(),
                                            Align(
                                              alignment: Alignment.bottomRight,
                                              child: GetBuilder<FollowAstrologerController>(
                                                builder: (followAstrologerController) {
                          ...
                          return InkWell(
                            onTap: () async {
                              ...
                              if (isLogin) {
                                double charge = double.parse(bottomNavigationController.astrologerbyId[0].charge!.toString());
                                if (charge * 5 <= global.splashController.currentUser!.walletAmount! || bottomNavigationController.astrologerbyId[0].isFreeAvailable == true) {
                                  if (bottomNavigationController.astrologerbyId[0].chatStatus == "Online") {
                                    await bottomNavigationController.checkAlreadyInReq(bottomNavigationController.astrologerbyId[0].id!);
                                    if (bottomNavigationController.isUserAlreadyInChatReq == false) {
                                      global.showOnlyLoaderDialog(context);
                                  ...
                                  } else if (bottomNavigationController.astrologerbyId[0].chatStatus == "Offline" || bottomNavigationController.astrologerbyId[0].chatStatus == "Wait Time") {
                                    dialogForJoinInWaitList(context, bottomNavigationController.astrologerbyId[0].name!, true, bottomNavigationController.astrologerbyId[0].chatStatus.toString());
                                  } else if (bottomNavigationController.astrologerbyId[0].chatStatus == "Busy") {
                                    dialogForJoinInWaitList(context, bottomNavigationController.astrologerbyId[0].name!, true, bottomNavigationController.astrologerbyId[0].chatStatus.toString());
                                  }
                                } else {
                                  global.showOnlyLoaderDialog(context);
                            ...
                            child: Card(
                              ...
                              color: bottomNavigationController.astrologerbyId[0].chatStatus == "Online" ? Colors.lightBlue : Colors.orangeAccent, //Get.theme.primaryColor,
                              elevation: 10,
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceAround,
                                children: [
                                  ...
                                  Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            Text("Chat", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr(),
                                            bottomNavigationController.astrologerbyId[0].chatStatus == "Offline" || bottomNavigationController.astrologerbyId[0].chatStatus == "Busy"
                                                ? Text(bottomNavigationController.astrologerbyId[0].chatStatus == "Offline" ? "Currently Offline" : 'Currently Busy', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.w500)).tr()
                                                : bottomNavigationController.astrologerbyId[0].chatStatus == "Online"
                                                ? SizedBox()
                                                : Text(
                                                  bottomNavigationController.astrologerbyId[0].chatWaitTime!.difference(DateTime.now()).inMinutes > 0 ? "Wait till - ${bottomNavigationController.astrologerbyId[0].chatWaitTime!.difference(DateTime.now()).inMinutes} min" : "Waiting",
                                                  textAlign: TextAlign.center,
                          ...
                          return InkWell(
                            onTap: () async {
                              ...
                              if (isLogin) {
                                double charge = double.parse(bottomNavigationController.astrologerbyId[0].charge!.toString());
                                if (charge * 5 <= global.splashController.currentUser!.walletAmount! || bottomNavigationController.astrologerbyId[0].isFreeAvailable == true) {
                                  if (bottomNavigationController.astrologerbyId[0].callStatus == "Online") {
                                    await bottomNavigationController.checkAlreadyInReqForCall(bottomNavigationController.astrologerbyId[0].id!);
                                    if (bottomNavigationController.isUserAlreadyInCallReq == false) {
                                      global.showOnlyLoaderDialog(context);
                                      if (bottomNavigationController.astrologerbyId[0].callWaitTime != null) {
                                  ...
                                  } else if (bottomNavigationController.astrologerbyId[0].callStatus == "Offline" || bottomNavigationController.astrologerbyId[0].callStatus == "Busy" || bottomNavigationController.astrologerbyId[0].callStatus == "Wait Time") {
                                    dialogForJoinInWaitList(context, bottomNavigationController.astrologerbyId[0].name!, true, bottomNavigationController.astrologerbyId[0].chatStatus.toString());
                                  }
                                } else {
                                  global.showOnlyLoaderDialog(context);
                            ...
                            child: Card(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0)),
                              color: bottomNavigationController.astrologerbyId[0].callStatus == "Online" ? Colors.green : Colors.orangeAccent, //Get.theme.primaryColor,
                              elevation: 10,
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceAround,
                                children: [
                                  ...
                                  Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            Text("Audio", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr(),
                                            bottomNavigationController.astrologerbyId[0].callStatus == "Offline" || bottomNavigationController.astrologerbyId[0].callStatus == "Busy"
                                                ? Text(bottomNavigationController.astrologerbyId[0].callStatus == "Offline" ? "Currently Offline" : "Currently Busy", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.w500)).tr()
                                                : bottomNavigationController.astrologerbyId[0].callStatus == "Online"
                                                ? SizedBox()
                                                : Text(
                                                  bottomNavigationController.astrologerbyId[0].callWaitTime!.difference(DateTime.now()).inMinutes > 0 ? "Wait till - ${bottomNavigationController.astrologerbyId[0].callWaitTime!.difference(DateTime.now()).inMinutes} min" : "Waiting",
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.w500),
                                                ).tr(),
                                          ],
                          ...
                          return InkWell(
                            onTap: () async {
                              ...
                              if (isLogin) {
                                ...
                                print("${bottomNavigationController.astrologerbyId[0].videoCallRate!.toString()}");
                                double charge = double.parse(bottomNavigationController.astrologerbyId[0].videoCallRate!.toString());
                                if (charge * 5 <= global.splashController.currentUser!.walletAmount! || bottomNavigationController.astrologerbyId[0].isFreeAvailable == true) {
                                  if (bottomNavigationController.astrologerbyId[0].callStatus == "Online") {
                                    await bottomNavigationController.checkAlreadyInReqForCall(bottomNavigationController.astrologerbyId[0].id!);
                                    if (bottomNavigationController.isUserAlreadyInCallReq == false) {
                                      ...
                                      await Get.to(
                                        () => CallIntakeFormScreen(
                                          ...
                                          astrologerName: bottomNavigationController.astrologerbyId[0].name!,
                                          isFreeAvailable: bottomNavigationController.astrologerbyId[0].isFreeAvailable,
                                          rate: bottomNavigationController.astrologerbyId[0].videoCallRate.toString(),
                                        ),
                                      );
                            ...
                            child: Card(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0)),
                              color: bottomNavigationController.astrologerbyId[0].callStatus == "Online" ? Colors.redAccent : Colors.orangeAccent, //Get.theme.primaryColor,
                              elevation: 10,
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceAround,
                                children: [
                                  ...
                                  Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            Text("Video", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr(),
                                            bottomNavigationController.astrologerbyId[0].callStatus == "Offline" || bottomNavigationController.astrologerbyId[0].callStatus == "Busy"
                                                ? Text(bottomNavigationController.astrologerbyId[0].callStatus == "Busy" ? 'Currently Busy' : "Currently Offline", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.w500)).tr()
                                                : bottomNavigationController.astrologerbyId[0].callStatus == "Online"
                                                ? SizedBox()
                                                : Text(
                                                  bottomNavigationController.astrologerbyId[0].callWaitTime!.difference(DateTime.now()).inMinutes > 0 ? "Wait till - ${bottomNavigationController.astrologerbyId[0].callWaitTime!.difference(DateTime.now()).inMinutes} min" : "Waiting",
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Row(children: [Icon(icon, color: Colors.grey), SizedBox(width: 5), Text(s).tr()]),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child:
                                        minBalance != ''
                                            ? Text('Minimum balance of 5 minutes(${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} $minBalance) is required to start $type with $astrologer ', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.red)).tr()
                                            : const SizedBox(),
                                  ),
                                  GestureDetector(
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [Padding(padding: const EdgeInsets.only(right: 5), child: Icon(Icons.lightbulb_rounded, color: Get.theme.primaryColor, size: 13)), Expanded(child: Text('Tip:90% users rechage for 10 mins or more.', style: TextStyle(fontSize: 12)).tr())],
                              ),
                            ],
                          ),
                        ),
