...
class AddNewAddressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(preferredSize: Size.fromHeight(56), child: CommonAppBar(title: id != null ? 'Edit Address' : 'Address')),
          ...
          child: GetBuilder<AstromallController>(
            builder: (astromallController) {
              return Column(
                ...
                children: [
                  TextFieldWidget(controller: astromallController.nameController, labelText: tr('Name'), focusNode: astromallController.namefocus, inputFormatter: [FilteringTextInputFormatter.allow(RegExp("[a-zA-Z ]"))]),
                  Padding(
                  ...
                  TextFieldWidget(controller: astromallController.flatNoController, labelText: 'Flat number', keyboardType: TextInputType.number),
                  TextFieldWidget(controller: astromallController.localityController, labelText: 'Locality'),
                  TextFieldWidget(controller: astromallController.landmarkController, labelText: 'Landmark'),
                  TextFieldWidget(controller: astromallController.cityController, labelText: 'City', inputFormatter: [FilteringTextInputFormatter.allow(RegExp("[a-zA-Z ]"))]),
                  TextFieldWidget(controller: astromallController.stateController, labelText: 'State/Province', inputFormatter: [FilteringTextInputFormatter.allow(RegExp("[a-zA-Z ]"))]),
                  TextFieldWidget(controller: astromallController.countryController, labelText: 'Country', inputFormatter: [FilteringTextInputFormatter.allow(RegExp("[a-zA-Z ]"))]),
                  TextFieldWidget(controller: astromallController.pinCodeController, labelText: 'Pincode', keyboardType: TextInputType.number, maxlen: 6),
                ],
              );
            },
          ),
        ...
        builder: (astromallController) {
          return CustomBottomButton(
            ...
            onTap: () async {
              ...
              if (!isvalid) {
                global.showToast(message: astromallController.errorText, textColor: global.textColor, bgColor: global.toastBackGoundColor);
              } else {
