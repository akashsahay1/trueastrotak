...
import 'package:trueastrotalk/views/astromall/addressScreen.dart';
import 'package:trueastrotalk/views/imagePreview.dart';
    ...
    return GetBuilder<AstromallController>(
      builder: (astromallController) {
        return Scaffold(
          ...
          appBar: PreferredSize(preferredSize: Size.fromHeight(56), child: CommonAppBar(title: 'Product details')),
          bottomSheet:
              astromallController.isScrollable
                  ? CustomBottomButton(
                    title: 'Book Now',
                    onTap: () async {
                  ...
                  children: [
                    Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Get.to(() => ImagePreview(image: "${global.imgBaseurl}${astromallController.astroProductbyId[0].productImage}"));
                        },
                        child: Padding(padding: const EdgeInsets.all(8.0), child: Image.network("${global.imgBaseurl}${astromallController.astroProductbyId[0].productImage}", fit: BoxFit.cover)),
                      ),
                    ),
                    SizedBox(height: 10),
                    Text(astromallController.astroProductbyId[0].name, style: Get.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold)),
                    Text(astromallController.astroProductbyId[0].features, style: Get.textTheme.titleMedium!.copyWith(color: Colors.grey, fontSize: 14)),
                    SizedBox(height: 5),
                    Text('${tr("Starting from:")}${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} ${astromallController.astroProductbyId[0].amount}/-', style: Get.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold)),
                    SizedBox(height: 10),
                    TextButton(
                      onPressed: () async {
                        bool isLogin = await global.isLogin();
                      ...
                      child: Text('Book Now', style: Get.textTheme.titleMedium!.copyWith(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 15)).tr(),
                      style: ButtonStyle(backgroundColor: WidgetStateProperty.all(Colors.black), foregroundColor: WidgetStateProperty.all(Colors.white), shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)))),
                    ),
                    SizedBox(height: 20),
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(astromallController.astroProductbyId[0].questionAnswer[index].question, style: Get.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold)),
                                  SizedBox(height: 10),
                                  Text(astromallController.astroProductbyId[0].questionAnswer[index].answer, style: Get.textTheme.titleMedium!.copyWith(color: Colors.grey, fontSize: 14)),
                                ],
                              ),
                            );
                          },
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        PopupMenuButton(
                                          icon: Icon(Icons.more_vert, color: Color.fromRGBO(158, 158, 158, 1)),
                                          ...
                                          itemBuilder: (context) => [PopupMenuItem(value: 'report', child: Text('Report review').tr()), PopupMenuItem(value: 'block', child: Text('Block review', style: Get.textTheme.titleMedium!.copyWith(color: Colors.red)).tr())],
                                        ),
                                      ],
                                    ),
                                    Row(
                                      ...
                                      children: [
                                        RatingBar.builder(
                                          ...
                                          itemSize: 15,
                                          ignoreGestures: true,
                                          itemBuilder: (context, _) => Icon(Icons.star, color: Get.theme.primaryColor),
