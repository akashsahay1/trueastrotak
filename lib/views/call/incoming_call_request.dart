              ...
              children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(astrologerName == null || astrologerName == "" ? "Astrologer" : astrologerName ?? "Astrologer", style: Get.textTheme.headlineSmall).tr(),
                        ],
                      ),
                      Text("Please accept call request", style: Get.textTheme.bodyLarge).tr(),
                    ],
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: Row(
                    ...
                    children: [CircleAvatar(backgroundColor: Get.theme.primaryColor, backgroundImage: AssetImage("assets/images/splash.png")), const SizedBox(width: 15), Text('${global.getSystemFlagValue(global.systemFlagNameList.appName)}', style: Get.textTheme.headlineSmall)],
                  ),
                ),
                Expanded(
                  flex: 1,
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(padding: const EdgeInsets.all(10), margin: const EdgeInsets.only(right: 20), decoration: BoxDecoration(color: Colors.red, borderRadius: BorderRadius.circular(30)), child: Icon(Icons.phone, color: Colors.white)),
                          ),
                          InkWell(
                            onTap: () async {
                              global.showOnlyLoaderDialog(context);
                            ...
                            child: Container(padding: const EdgeInsets.all(10), margin: const EdgeInsets.only(left: 20), decoration: BoxDecoration(color: Colors.green, borderRadius: BorderRadius.circular(30)), child: Icon(Icons.ring_volume, color: Colors.white)),
                          ),
                        ],
                      ),
                    ],
