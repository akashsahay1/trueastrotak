            ...
            return GestureDetector(
              ...
              child: Column(
                children: [
                          ...
                          Column(
                            children: [
                              ...
                              counsellorController.counsellorList[index].totalOrder == 0
                                  ? SizedBox()
                                  : Text(' ${counsellorController.counsellorList[index].totalOrder} ${tr("orders")}', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, fontSize: 9, color: Colors.grey)),
                            ],
                          ),
                          Expanded(
                            child: Padding(
                          ...
                          Column(
                            children: [
                              TextButton(
                                ...
                                child: Text('Call', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(color: Colors.white)).tr(),
                              ),
                            ],
                          ),
                        ],
                  ...
                  index == counsellorController.counsellorList.length - 1 ? const SizedBox(height: 40) : const SizedBox(),
                ],
              ),
            );
          },
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child:
                                        minBalance != ''
                                            ? Text('${tr("Minimum balance of 5 minutes")}(${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} $minBalance) ${tr("is required to start call with")} $astrologer ', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.red))
                                            : const SizedBox(),
                                  ),
                                  GestureDetector(
