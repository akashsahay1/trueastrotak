      ...
      builder: (c) {
        return Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            titleStyle: Get.theme.primaryTextTheme.titleSmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.white),
          ...
          body: RefreshIndicator(
            ...
            child: GetBuilder<CounsellorController>(
              builder: (counsellorController) {
                return counsellorController.isCall ? CallWithCounsellors(counsellorController: counsellorController) : ChatWithCounSellor(counsellorController: counsellorController);
              },
            ),
          ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: counsellorController.isChat ? Get.theme.primaryColor : Colors.transparent, border: Border.all(color: counsellorController.isChat ? Colors.grey : Colors.transparent), borderRadius: BorderRadius.circular(15)),
                          child: Text('Chat').tr(),
                        ),
                      ),
                      GestureDetector(
                        ...
                        child: Container(
                          padding: EdgeInsets.symmetric(horizontal: 10, vertical: 0),
                          decoration: BoxDecoration(color: counsellorController.isCall ? Get.theme.primaryColor : Colors.transparent, border: Border.all(color: counsellorController.isCall ? Colors.grey : Colors.transparent), borderRadius: BorderRadius.circular(15)),
                          child: Text("Call").tr(),
                        ),
                      ),
                    ],
