        ...
        child: GetBuilder<CustomerSupportController>(
          builder: (customerSupportController) {
            return customerSupportController.ticketList.isEmpty
                ? Center(child: Text('No ticket available').tr())
                : Column(
                          ...
                          return GestureDetector(
                            ...
                            onLongPress: () {
                              ...
                              Get.dialog(
                                AlertDialog(
                                  backgroundColor: Colors.white,
                                  title: Text("Are you sure you want delete ticket?", style: Get.textTheme.titleMedium).tr(),
                                  content: Row(
                                    children: [
                                      Expanded(
                                        flex: 4,
                                      ...
                                      Expanded(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () async {
                                            global.showOnlyLoaderDialog(context);
                                            await customerSupportController.deleteOneTicket(customerSupportController.ticketList[index].id!);
                                            global.hideLoader();
                                            Get.back();
                                          },
                                          child: Text('Yes').tr(),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Expanded(child: Text("${customerSupportController.ticketList[index].name}".toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold))),
                                          customerSupportController.ticketList[index].ticketStatus!.toUpperCase() == "PAUSE"
                                              ...
                                              : Text(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  color:
                                                      customerSupportController.ticketList[index].ticketStatus!.toUpperCase() == "WAITING"
                                                          ? Colors.blue
              ...
              if (!customerSupportController.isOpenTicket) {
                ...
                Get.dialog(
                  AlertDialog(
                    ...
                    title: Text("You already have an open ticket", style: Get.textTheme.titleMedium).tr(),
                    content: TextButton(
                      onPressed: () {
                        Get.back();
                      },
