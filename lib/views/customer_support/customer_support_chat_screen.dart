      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            title: GestureDetector(onTap: () async {}, child: Text('${tr("Ticket No")}: $ticketNo', style: Get.theme.primaryTextTheme.titleLarge!.copyWith(fontSize: 18, fontWeight: FontWeight.normal, color: Colors.white))),
            leading: IconButton(
              onPressed: () async {
                customerSupportController.isIn = false;
                customerSupportController.update();
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(messageList[index].message!, style: TextStyle(color: customerSupportController.isMe ? Colors.black : Colors.white), textAlign: customerSupportController.isMe ? TextAlign.end : TextAlign.start),
                                ...
                                return Align(
                                  ...
                                  child: Card(
                                    ...
                                    child: Container(
                                      width: Get.width,
                                      padding: const EdgeInsets.all(8),
                                      decoration: BoxDecoration(color: Color.fromARGB(255, 228, 224, 193), border: Border.all(color: Get.theme.primaryColor)),
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Text('uh oh! It seems like you were away.Don\'t worry our support manager will join soon to resume your ticket.').tr(),
                                          ElevatedButton(
                                            onPressed: () async {
                                  ...
                                  child: Card(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        mainAxisSize: MainAxisSize.min,
                                        children: [Text('Please wait while our support manager joins the chat.It might take up to 20 minutes for the chat to initiate.We will notify you once the chat initiates.').tr(), Text('wait Time ~ 20m', style: TextStyle(color: Colors.red)).tr()],
                                      ),
                                    ),
                                  ),
                                );
                                                  ...
                                                  children: [
                                                    ...
                                                    TextField(
                                                      ...
                                                      decoration: InputDecoration(
                                                        ...
                                                        hintText: tr("Describe your experience(optional)"),
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                              ...
                                                              children: [
                                                                CachedNetworkImage(
                                                                  ...
                                                                  imageBuilder: (context, imageProvider) {
                                                                    return CircleAvatar(radius: 22, backgroundColor: Colors.white, backgroundImage: NetworkImage("${global.imgBaseurl}${global.splashController.currentUser?.profile}"));
                                                                  },
                                                                ...
                                                                Column(
                                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                                  children: [
                                                                    Text(global.splashController.currentUser!.name ?? 'User'),
                                                                    RatingBar(
                                                                      initialRating: customerSupportController.rating,
                                                                      itemCount: 5,
                                                                      allowHalfRating: true,
                                                                    ...
                                                                    Text(customerSupportController.reviewController.text),
                                                                  ],
                                                                ),
                                                              ],
                                                            ),
                                                        ...
                                                        GestureDetector(
                                                          ...
                                                          child: Center(child: Text('Edit your review', style: TextStyle(color: Colors.green)).tr()),
                                                        ),
                                                        SizedBox(height: 5),
                                                      ],
                                                    ),
