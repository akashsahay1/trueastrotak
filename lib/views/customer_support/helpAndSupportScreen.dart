...
import 'package:trueastrotalk/views/customer_support/helpOptionScreen.dart';
import 'package:trueastrotalk/widget/commonListTileWidget.dart';
            ...
            return CommonListTileWidget(
              ...
              onTap: () async {
                if (customerSupportController.helpAndSupport[i].isSubCategory!) {
                  ...
                  global.hideLoader();
                  Get.to(() => HelpOptionScreen(helpSupportQuestionId: customerSupportController.helpAndSupport[i].id, title: customerSupportController.helpAndSupport[i].name));
                }
              },
            );
          },
