...
class HelpOptionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          customerSupportController.helpAndSupportQuestion.isEmpty
              ? Center(child: Text('No Question Available').tr())
                        ...
                        return CommonListTileWidget(
                          ...
                          onTap: () async {
                            if (customerSupportController.helpAndSupportQuestion[i].isSubCategory!) {
                              ...
                              global.hideLoader();
                              Get.to(() => HelpDetailsScreen(index: i, title: customerSupportController.helpAndSupportQuestion[i].question, helpSupportQuestionId: helpSupportQuestionId, helpSupportQuestion: title));
                            }
                          },
                        );
                      },
