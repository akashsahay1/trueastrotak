...
class FreeServiceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Free Services', style: Get.theme.primaryTextTheme.titleLarge!.copyWith(fontSize: 18, fontWeight: FontWeight.normal, color: Colors.white)).tr(),
        leading: IconButton(
          onPressed: () => Get.back(),
          icon: Icon(
            kIsWeb
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Today\'s Panchang', style: Get.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold)).tr(), Text('New Delhi,Delhi,India', style: Get.textTheme.bodySmall).tr()]),
                              Row(
                              ...
                              kundliController.kundliBasicPanchangDetail == null
                                  ? SizedBox()
                                  : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [SizedBox(width: 150, child: Text('Tithi').tr()), Text('${kundliController.kundliBasicPanchangDetail!.tithi}', style: Get.textTheme.bodyMedium!.copyWith(color: Colors.grey)).tr()]),
                              kundliController.kundliBasicPanchangDetail == null
                                  ? SizedBox()
                                  : Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [SizedBox(width: 150, child: Text('Yoga').tr()), Text('${kundliController.kundliBasicPanchangDetail!.yog != null ? kundliController.kundliBasicPanchangDetail!.yog : '--'}', style: Get.textTheme.bodyMedium!.copyWith(color: Colors.grey)).tr()],
                                  ),
                              kundliController.kundliBasicPanchangDetail == null
                                  ? SizedBox()
                                  : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [SizedBox(width: 150, child: Text('Nakshatra').tr()), Text('${kundliController.kundliBasicPanchangDetail!.nakshatra}', style: Get.textTheme.bodyMedium!.copyWith(color: Colors.grey)).tr()]),
                            ],
                          ),
                        ),
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('View More', style: TextStyle(color: Colors.white)).tr(), SizedBox(width: 10), Icon(Icons.arrow_forward_ios, size: 15, color: Colors.white)]),
                          ),
                        ),
                      ],
                    ),
                                                      ...
                                                      bottomNavigationController.liveAstrologer[index].profileImage != ""
                                                          ? Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                              ...
                                                              image: DecorationImage(fit: BoxFit.cover, image: NetworkImage('${global.imgBaseurl}${bottomNavigationController.liveAstrologer[index].profileImage}'), colorFilter: ColorFilter.mode(Colors.black.withOpacity(0.3), BlendMode.darken)),
                                                            ),
                                                          )
                                                          : Container(
                                                            width: 95,
                                      ...
                                      child: GetBuilder<BlogController>(
                                        builder: (blog) {
                                          return Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text('Astrology blog', style: Get.theme.primaryTextTheme.titleMedium!.copyWith(fontWeight: FontWeight.w500)).tr(),
                                              GestureDetector(
                                                onTap: () async {
                                                  ...
                                                  children: [
                                                        ...
                                                        Positioned(
                                                          ...
                                                          child: ElevatedButton(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [const Icon(Icons.visibility, size: 20), Padding(padding: EdgeInsets.only(left: 5.0), child: Text("${homeController.blogList[index].viewer}", style: TextStyle(fontSize: 12)))],
                                                            ),
                                                          ),
                                                        ),
                                                      ],
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text("${homeController.blogList[index].title}", textAlign: TextAlign.start, style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 13, fontWeight: FontWeight.w400, letterSpacing: 0)).tr(),
                                                          Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              Text('${homeController.blogList[index].author}', textAlign: TextAlign.center, style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 13, fontWeight: FontWeight.w400, color: Colors.grey[350], letterSpacing: 0)).tr(),
                                                              Text(
                                                                "${DateFormat("MMM d,yyyy").format(DateTime.parse(homeController.blogList[index].createdAt))}",
                                                                textAlign: TextAlign.center,
                                                                style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 13, fontWeight: FontWeight.w400, color: Colors.grey[350], letterSpacing: 0),
                                                              ),
                                                            ],
                                                          ),
                                                        ],
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Watch Astrology Videos', style: Get.theme.primaryTextTheme.titleMedium!.copyWith(fontWeight: FontWeight.w500)).tr(),
                                          GestureDetector(
                                            onTap: () {
                                                  ...
                                                  children: [
                                                    Stack(
                                                      children: [
                                                        ...
                                                        Positioned(left: 60, child: Image.asset(Images.youtube, height: 120, width: 120)),
                                                      ],
                                                    ),
                                                    Padding(
                                                      padding: const EdgeInsets.only(left: 5, right: 5, top: 3, bottom: 3),
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            ...
                                                            style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 13, fontWeight: FontWeight.w400, letterSpacing: 0),
                                                          ).tr(),
                                                          Row(
  ...
  Widget customContainer(String img) {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.black, border: Border.all(color: Get.theme.primaryColor), borderRadius: BorderRadius.circular(15)),
      child: CachedNetworkImage(imageUrl: img, imageBuilder: (context, imageProvider) => Image.network(img, height: 100, width: 100), placeholder: (context, url) => const Center(child: CircularProgressIndicator()), errorWidget: (context, url, error) => Icon(Icons.no_accounts, size: 20)),
    );
  }
  ...
  Widget detailText(String title, String subtitle, String btnText, VoidCallback btnTap) {
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: Get.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold)).tr(),
        SizedBox(height: 10),
        Text(subtitle, style: Get.textTheme.bodyMedium!.copyWith(fontSize: 12)).tr(),
        TextButton(
          onPressed: btnTap,
          child: Text(btnText, style: TextStyle(color: Colors.white)).tr(),
          style: ButtonStyle(
            shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(7))),
            padding: WidgetStateProperty.all(EdgeInsets.symmetric(horizontal: 10, vertical: 6)),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: containerColor, border: Border.all(color: borderColors), borderRadius: BorderRadius.circular(15)),
