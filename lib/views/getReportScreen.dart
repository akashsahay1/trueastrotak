  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Get Detailed Report', style: Get.theme.primaryTextTheme.titleLarge!.copyWith(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.white)).tr(),
        leading: IconButton(
          onPressed: () => Get.back(),
          icon: Icon(
            kIsWeb
        ...
        child: GetBuilder<BottomNavigationController>(
          builder: (bottomNavigationController) {
            return bottomNavigationController.astrologerList.isEmpty
                ? Center(child: Text('Astrologer not Available').tr())
                : ListView.builder(
                    ...
                    return GestureDetector(
                      ...
                      child: Column(
                        children: [
                                    ...
                                    children: [
                                      Stack(
                                        children: [
                                          ...
                                          Positioned(right: 0, child: Image.asset(Images.right, height: 18)),
                                        ],
                                      ),
                                      ...
                                      Row(
                                        children: [
                                          Image.asset(Images.userProfile, height: 10, width: 10),
                                          SizedBox(width: 5),
                                          Text('${bottomNavigationController.astrologerList[index].totalOrder} orders', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, fontSize: 9)).tr(),
                                        ],
                                      ),
                                    ],
                                  ),
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(bottomNavigationController.astrologerList[index].name!).tr(),
                                          Text(bottomNavigationController.astrologerList[index].allSkill!, style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                          Text(bottomNavigationController.astrologerList[index].languageKnown!, style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                          Text('${tr("Experience")}: ${bottomNavigationController.astrologerList[index].experienceInYears} ${tr("Years")}', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                          Row(
                                            children: [
                                              Text(
                                                ...
                                                style: Get.theme.textTheme.titleMedium!.copyWith(color: Colors.black54, fontSize: 15, fontWeight: FontWeight.w500, letterSpacing: 0),
                                              ).tr(),
                                            ],
                                          ),
                                        ],
                                  ...
                                  Column(
                                    children: [
                                      TextButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (isLogin) {
                                            ...
                                            if (charge <= global.splashController.currentUser!.walletAmount!) {
                                              ...
                                              global.hideLoader();
                                              Get.to(() => ReportTypeScreen(astrologerId: bottomNavigationController.astrologerList[index].id!, astrologerName: bottomNavigationController.astrologerList[index].name!));
                                            } else {
                                              global.showOnlyLoaderDialog(context);
                                              await walletController.getAmount();
                                              global.hideLoader();
                                        ...
                                        child: Text('Get report', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(color: Colors.white)).tr(),
                                      ),
                                    ],
                                  ),
                                ],
                          ...
                          index == bottomNavigationController.astrologerList.length - 1 ? const SizedBox(height: 50) : const SizedBox(),
                        ],
                      ),
                    );
                  },
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                                        ...
                                        children: [
                                          GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              child: Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: 15, top: 8, bottom: 8), child: Text(reportController.reportSorting[index].name!).tr())),
                                            ),
                                          ),
                                          Divider(height: 0),
                                        ],
                ...
                child: Row(children: [Icon(Icons.sort, size: 18), SizedBox(width: 15), Text('SORT').tr()]),
              ),
              ...
              GestureDetector(
                ...
                child: Row(children: [Icon(Icons.sort, size: 18), SizedBox(width: 15), Text('Filter').tr()]),
              ),
            ],
          ),
        ),
                  ...
                  Obx(
                    () => RotatedBox(
                      ...
                      child: TabBar(
                        ...
                        tabs: List.generate(reportFilter.reportFilter.length, (ind) {
                          return RotatedBox(
                            quarterTurns: -1,
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Container(width: 5, decoration: BoxDecoration(borderRadius: BorderRadius.only(topRight: Radius.circular(5), bottomRight: Radius.circular(5)), color: reportFilter.selectedFilterIndex.value == ind ? Colors.white : Colors.black)),
                                  Container(width: MediaQuery.of(context).size.width * 0.25, alignment: Alignment.centerLeft, padding: EdgeInsets.symmetric(horizontal: 8), child: Text(reportFilter.reportFilter[ind], style: TextStyle(color: Colors.black54)).tr()),
                                ],
                              ),
                            ),
                          );
                            ...
                            child: RotatedBox(
                              ...
                              child: Padding(
                                ...
                                child: ListView.builder(
                                  ...
                                  padding: EdgeInsets.zero,
                                  itemBuilder: (context, index) {
                                    return GetBuilder<ReportFilterTabController>(
                                      builder: (filterController) {
                                        return CheckboxListTile(
                                          ...
                                          title: Text(reportFilter.gender[index].name).tr(),
                                        );
                                      },
                                    );
                                  },
                          ...
                          child: SizedBox(
                            ...
                            child: TextButton(
                              onPressed: () async {
                                ...
                                await bottomController.getAstrologerList(skills: skillController.skillFilterList, gender: reportFilter.genderFilterList, language: languageController.languageFilterList);
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child:
                                        minBalance != ''
                                            ? Text('${tr("Minimum balance")} ${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} $minBalance is required to get report from $astrologer ', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.red)).tr()
                                            : const SizedBox(),
                                  ),
                                  GestureDetector(
