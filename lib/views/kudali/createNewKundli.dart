            ...
            child: GetBuilder<KundliController>(
              builder: (c) {
                return Column(
                  ...
                  children: [
                    Row(mainAxisSize: MainAxisSize.min, children: [InkWell(onTap: () => Get.back(), child: const Icon(Icons.arrow_back_ios)), const SizedBox(width: 10), Text('Kundli', style: Get.textTheme.titleMedium).tr()]),
                    SizedBox(
                      height: 60,
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child:
                                kundliController.listIcon[index].isSelected
                                    ? CircleAvatar(radius: 13, backgroundColor: Get.theme.primaryColor, child: Icon(kundliController.listIcon[kundliController.initialIndex].icon, size: 15, color: Colors.black))
                                    ...
                                    ? GestureDetector(
                                      ...
                                      child: CircleAvatar(radius: 10, backgroundColor: Get.theme.primaryColor),
                                    )
                    ...
                    if (kundliController.initialIndex == 1) KundliGenderWidget(kundliController: kundliController),
                    ...
                    if (kundliController.initialIndex == 4) KundliBornPlaceWidget(kundliController: kundliController),
                  ],
                );
              },
            ),
