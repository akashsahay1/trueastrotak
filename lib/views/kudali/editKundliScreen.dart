...
class EditKundliScreen extends StatelessWidget {
    ...
    return SafeArea(
      child: Scaffold(
        body: Container(
          ...
          decoration: BoxDecoration(gradient: LinearGradient(begin: Alignment.bottomCenter, end: Alignment.topLeft, colors: [Get.theme.primaryColor, Colors.white])),
            ...
            child: GetBuilder<KundliController>(
              builder: (kundliController) {
                return Column(
                  ...
                  children: [
                    Row(mainAxisSize: MainAxisSize.min, children: [InkWell(onTap: () => Get.back(), child: Icon(Icons.arrow_back_ios)), const SizedBox(width: 10), Text('Edit Kundli', style: Get.textTheme.titleMedium).tr()]),
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CommonSmallTextFieldWidget(controller: kundliController.editNameController, titleText: "", hintText: "Enter Name", keyboardType: TextInputType.text, preFixIcon: Icons.person_outline, maxLines: 1, onFieldSubmitted: (p0) {}, onTap: () {}),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.transgender, color: Colors.grey, size: 20),
                                  ...
                                  child: DropdownButton(
                                    ...
                                    items:
                                        ['Male', 'Female', 'Other'].map<DropdownMenuItem<String>>((String value) {
                                          return DropdownMenuItem<String>(value: value, child: Center(child: SizedBox(width: double.infinity, child: Text(value, style: Get.theme.primaryTextTheme.bodyLarge, textAlign: TextAlign.start))));
                                        }).toList(),
                                    onChanged: (value) {
                          ...
                          SizedBox(
                            ...
                            child: TextButton(
                              style: ButtonStyle(
                                ...
                                shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(15), side: BorderSide(color: Colors.grey))),
                              ),
                              onPressed: () async {
                              ...
                              child: Text('Update', textAlign: TextAlign.center, style: Get.theme.primaryTextTheme.titleMedium!.copyWith(color: Colors.white)).tr(),
                            ),
                          ),
                        ],
                      ),
  ...
  Future _selectDate(BuildContext context, KundliController kundliController) async {
    ...
    var datePicked = await DatePicker.showSimpleDatePicker(
      ...
      itemTextStyle: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 15, fontWeight: FontWeight.w400, letterSpacing: 0, wordSpacing: 2),
  ...
  Future _boySelectBirthDateTime(BuildContext context, KundliController kundliController) async {
    TimeOfDay? pickedTime = await showTimePicker(
      ...
      builder: (context, child) {
        return Theme(data: ThemeData(textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(backgroundColor: Get.theme.primaryColor, foregroundColor: Colors.black)), colorScheme: ColorScheme.light(primary: Get.theme.primaryColor, onSurface: Colors.white)), child: child ?? SizedBox());
      },
    );
    if (pickedTime != null) {
