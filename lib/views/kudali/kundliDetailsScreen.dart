  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Kundli', style: Get.theme.primaryTextTheme.titleLarge!.copyWith(fontSize: 18, fontWeight: FontWeight.normal, color: Colors.white)).tr(),
        leading: IconButton(
          onPressed: () => Get.back(),
          icon: Icon(
            kIsWeb
        ...
        actions: [
          GestureDetector(
            onTap: () async {
              ...
              await kundliController.shareKundli(kundliController.pdfKundaliData!.recordList!.response.toString());
              global.hideLoader();
            },
            child: Padding(
      ...
      body:
          kundliController.pdfKundaliData == null
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [CircularProgressIndicator(), Text("Please Wait Kundali is Loading...")]))
              : Container(
