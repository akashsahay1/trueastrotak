      ...
      child: Scaffold(
            ...
            child:
                kIsWeb
                    ? Column(
                      ...
                      children: [
                        Row(children: [InkWell(onTap: () => Get.back(), child: Icon(Icons.arrow_back_ios)), SizedBox(width: 10), Text('Kundli', style: Get.textTheme.titleMedium).tr()]),
                        SizedBox(height: 15),
                        ...
                        GetBuilder<KundliController>(
                          builder: (kundliController) {
                            return kundliController.searchKundliList.length == 0
                                ? Column(children: [Container(height: 500, padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 10), alignment: Alignment.center, child: Text('Kundli not available', style: TextStyle(fontSize: 18)).tr())])
                                : ListView.builder(
                                  shrinkWrap: true,
                                        ...
                                        child: ListTile(
                                          ...
                                          subtitle: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(kundliController.searchKundliList[index].birthPlace, style: Get.textTheme.titleMedium!.copyWith(fontSize: 12, color: Colors.grey)).tr(),
                                            ],
                                          ),
                                          trailing: Row(
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                child: CircleAvatar(backgroundColor: Color.fromARGB(255, 235, 231, 231), radius: 12, child: Icon(Icons.edit, size: 14, color: Colors.black)),
                                              ),
                                              SizedBox(width: 10),
                                              GestureDetector(
                                                onTap: () {
                                                  Get.dialog(
                                                    AlertDialog(
                                                      backgroundColor: Colors.white,
                                                      title: Text("Are you sure you want to permanently delete this kundli?", style: Get.textTheme.bodyMedium).tr(),
                                                      content: Row(
                                                        children: [
                                                          Expanded(
                                                            flex: 4,
                                                ...
                                                child: CircleAvatar(backgroundColor: Color.fromARGB(255, 235, 231, 231), radius: 12, child: Icon(Icons.delete, size: 14, color: Colors.red)),
                                              ),
                                            ],
                                          ),
                                        ),
        ...
        bottomSheet: SizedBox(
          ...
          child: Padding(
            ...
            child: TextButton(
              style: ButtonStyle(padding: WidgetStateProperty.all(EdgeInsets.all(10)), backgroundColor: WidgetStateProperty.all(Get.theme.primaryColor), shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(7)))),
              onPressed: () {
              ...
              child: Text('Create New Kundli', textAlign: TextAlign.center, style: Get.theme.primaryTextTheme.titleMedium!.copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.white)).tr(),
            ),
          ),
        ),
      ),
