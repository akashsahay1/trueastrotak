      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                return SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedErrorBorder: OutlineInputBorder(borderSide: const BorderSide(color: Colors.red), borderRadius: BorderRadius.circular(25)),
                      errorBorder: OutlineInputBorder(borderSide: const BorderSide(color: Colors.red), borderRadius: BorderRadius.circular(25)),
                      focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Get.theme.primaryColor), borderRadius: BorderRadius.circular(25)),
                      hintText: "Search Kundli by Name",
                      prefixIcon: IconButton(onPressed: () {}, icon: const Icon(Icons.search, color: Colors.black, size: 20)),
                    ),
                  ),
                );
              },
            ...
            const Divider(),
            Padding(padding: const EdgeInsets.only(bottom: 10.0), child: Text("Recently Opened", style: Theme.of(context).primaryTextTheme.titleMedium).tr()),
            Expanded(
              child: GetBuilder<KundliController>(
                builder: (kundliController) {
                  return kundliController.searchKundliList.isEmpty
                      ? Center(child: Text(kundliController.emptyScreenText))
                      : ListView.separated(
                          ...
                          return GestureDetector(
                            ...
                            child: ListTile(
                              ...
                              title: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(kundliController.searchKundliList[index].name, style: Get.textTheme.titleMedium),
                                  Text("${DateFormat("dd MMM yyyy").format(kundliController.searchKundliList[index].birthDate)},${kundliController.searchKundliList[index].birthTime}", style: Theme.of(context).primaryTextTheme.titleSmall!.copyWith(fontSize: 10, color: Colors.grey)),
                                  Text(kundliController.searchKundliList[index].birthPlace, style: Theme.of(context).primaryTextTheme.titleSmall!.copyWith(fontSize: 10, color: Colors.grey)),
                                ],
                              ),
                              trailing: IconButton(
                                onPressed: () {
