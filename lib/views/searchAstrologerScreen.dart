...
import 'package:trueastrotak/views/astromall/astromallScreen.dart';
...
import 'package:trueastrotak/widget/popular_search_widget.dart';
import 'package:trueastrotak/widget/topServicesWidget.dart';
            ...
            child: AppBar(
              ...
              title: GetBuilder<SearchControllerCustom>(
                builder: (searchController) {
                  return Container(
                    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.grey, width: 0.1.w)),
                    width: 86.w,
                    height: 6.h,
                    child: Center(
                      child: TextField(
                        ...
                        onSubmitted: (value) async {
                          ...
                          searchController.update();
                          await searchController.getSearchResult(searchController.serachTextController.text, null, false);
                          searchController.update();
                        },
              ...
              actions: [
                Icon(Icons.settings, color: Colors.white), // Replace with your desired icon
              ],
            ),
          ),
        ),
        body: GetBuilder<SearchControllerCustom>(
          builder: (searchController) {
                            ...
                            children: [
                              TopServicesWidget(
                                ...
                                onTap: () {
                                  ...
                                  Get.to(() => BottomNavigationBarScreen(index: 3));
                                },
                              ),
                              TopServicesWidget(
                                icon: Icons.chat,
                ...
                : Column(
                  ...
                  children: [
                              ...
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(searchController.searchData[index].title, style: TextStyle(fontSize: 13)).tr(),
                                  ),
                                ),
                              );
                            },
                    ...
                    searchController.searchTabIndex == 0
                        ? Expanded(
                          child:
                              searchController.astrologerList.isEmpty
                                      ...
                                      return InkWell(
                                        ...
                                        child: Column(
                                          children: [
                                                          ...
                                                          children: [
                                                            ...
                                                            Positioned(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Center(child: Text(searchController.astrologerList[index].allSkill!.split(',')[0], overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.white, fontSize: 14.sp, fontWeight: FontWeight.w500))),
                                                              ),
                                                            ),
                                                          ],
                                                        ),
                                                    ...
                                                    Expanded(
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                          children: [
                                                            Row(children: [Text(searchController.astrologerList[index].name!).tr()]),
                                                            searchController.astrologerList[index].allSkill == ""
                                                                ? const SizedBox()
                                                                : Text(searchController.astrologerList[index].allSkill ?? "", style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                                            searchController.astrologerList[index].languageKnown == ""
                                                                ? const SizedBox()
                                                                : Text(searchController.astrologerList[index].languageKnown!, style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                                            Text('Experience  : ${searchController.astrologerList[index].experienceInYears}', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                                            type == 'Chat'
                                                                ? SizedBox()
                                                                : Row(
                                                                  children: [
                                                                    searchController.astrologerList[index].isFreeAvailable == true
                                                                        ? Text('FREE', style: Get.theme.textTheme.titleMedium!.copyWith(fontSize: 12, fontWeight: FontWeight.w500, letterSpacing: 0, color: Color.fromARGB(255, 167, 1, 1))).tr()
                                                                        : const SizedBox(),
                                                                    SizedBox(width: searchController.astrologerList[index].isFreeAvailable == true ? 10 : 0),
                                                                    Text(
                                                      ...
                                                      children: [
                                                        type == 'Chat'
                                                            ? TextButton(
                                                              style: ButtonStyle(
                                                                ...
                                                                backgroundColor: searchController.astrologerList[index].chatStatus == "Online" ? MaterialStateProperty.all(Colors.lightBlue) : MaterialStateProperty.all(Colors.orangeAccent),
                                                                    ...
                                                                    if (charge * 5 <= global.splashController.currentUser!.walletAmount! || searchController.astrologerList[index].isFreeAvailable == true) {
                                                                      ...
                                                                      if (bottomNavigationController.isUserAlreadyInChatReq == false) {
                                                                        if (searchController.astrologerList[index].chatStatus == "Online") {
                                                                          ...
                                                                          global.hideLoader();
                                                                        } else if (searchController.astrologerList[index].chatStatus == "Offline" || searchController.astrologerList[index].chatStatus == "Wait Time" || searchController.astrologerList[index].chatStatus == "Busy") {
                                                                  ...
                                                                  searchController.astrologerList[index].isFreeAvailable == true
                                                                      ...
                                                                      : Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text('${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} ${searchController.astrologerList[index].charge}/min', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(color: Colors.white)).tr(),
                                                                        ],
                                                                      ),
                                                            )
                                                            : SizedBox(
                                                                        ...
                                                                        child: GetBuilder<CallController>(
                                                                          builder:
                                                                              (CallController controller) => InkWell(
                                                                                        ...
                                                                                        if (bottomNavigationController.isUserAlreadyInCallReq == false) {
                                                                                          if (searchController.astrologerList[index].callStatus == "Online") {
                                                                                            ...
                                                                                            bottomNavigationController.dialogForJoinInWaitList(
                                                                                              ...
                                                                                              searchController.astrologerList[index].name ?? "Astro",
                                                                                              true,
                                                                                              bottomNavigationController.astrologerbyId[0].callStatus.toString(),
                                                                                              searchController.astrologerList[index].profileImage ?? "",
                                                                                            );
                                                                                          }
                                                                                        } else {
                                                                                ...
                                                                                child: CircleAvatar(radius: 18, backgroundColor: searchController.astrologerList[index].callStatus == "Online" ? Colors.green : Colors.orangeAccent, child: Center(child: Icon(Icons.call, color: Colors.white, size: 15))),
                                                                              ),
                                                                        ),
                                                                      ),
                                                                    ),
                                                                          ...
                                                                          builder:
                                                                              (CallController controller) => InkWell(
                                                                                ...
                                                                                child: CircleAvatar(
                                                                                  ...
                                                                                  child: Center(child: Icon(Icons.video_call, color: Colors.white, size: 15)),
                                                                                ),
                                                                              ),
                                                                        ),
                                                                      ),
                                                        ...
                                                        type == "Chat"
                                                            ? (searchController.astrologerList[index].chatStatus == "Offline"
                                                                ...
                                                                ? Text("Currently Busy", style: TextStyle(color: Colors.red, fontSize: 09)).tr()
                                                                : SizedBox())
                                                            ...
                                                            : searchController.astrologerList[index].callStatus == "Busy"
                                                            ? Text("Currently Busy", style: TextStyle(color: Colors.red, fontSize: 09)).tr()
                                                            : SizedBox(),
                                                        ...
                                                        searchController.astrologerList[index].totalOrder == 0 || searchController.astrologerList[index].totalOrder == null
                                                            ? SizedBox()
                                                            : Text('${searchController.astrologerList[index].totalOrder} orders', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, fontSize: 9)).tr(),
                                                      ],
                                                    ),
                                                  ],
                                                ),
                                            ...
                                            if (index == 2 - 1) const SizedBox(height: 30),
                                          ],
                                        ),
                                      );
                                    },
                        ...
                        : Expanded(
                          child:
                              searchController.astroProduct.isEmpty
                                  ? searchResultNotFound()
                                  : ListView.builder(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(searchController.astrologerList[index].name!).tr(),
                                                          Text('${searchController.astroProduct[index].features}', style: Get.textTheme.bodySmall).tr(),
                                                          Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              Text('Starting from: ${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)}${searchController.astroProduct[index].amount}/-', style: Get.textTheme.bodySmall).tr(),
                                                              Container(padding: const EdgeInsets.all(5), decoration: BoxDecoration(border: Border.all(color: Colors.grey, width: 2), borderRadius: BorderRadius.circular(12)), child: Text('Buy Now').tr()),
                                                            ],
                                                          ),
                                                        ],
                                                      ),
  ...
  Widget searchResultNotFound() {
    return Center(
      child: Column(
        ...
        children: [
          CircleAvatar(radius: 18, backgroundColor: Colors.red, child: Icon(Icons.close, color: Colors.white, size: 18)),
          const SizedBox(height: 10),
          Text('oops! No result found').tr(),
          Text('try searching something else').tr(),
          Text('Popular Searches', style: Get.textTheme.bodySmall!.copyWith(color: Colors.grey)).tr(),
          FittedBox(
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
