        ...
        title: GetBuilder<SearchControllerCustom>(
          builder: (searchController) {
            return TextField(
              ...
              decoration: InputDecoration(hintText: 'Search by Name', border: OutlineInputBorder(borderSide: BorderSide.none)),
            );
          },
        ),
      ...
      body: GetBuilder<SearchControllerCustom>(
        builder: (searchController) {
          return searchController.astrologerList.isEmpty
              ? Center(child: Text('Astrologer not found').tr())
              : ListView.builder(
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Row(children: [Image.asset(Images.userProfile, height: 10, width: 10), SizedBox(width: 5), Text('${searchController.astrologerList[index].totalOrder} orders', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, fontSize: 9)).tr()]),
                                  ],
                                ),
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(truncateText(searchController.astrologerList[index].name!), style: Get.theme.primaryTextTheme.titleMedium!.copyWith(fontWeight: FontWeight.w500, color: Colors.black54, fontSize: 15)).tr(),
                                        ...
                                        Text('Experience : ${searchController.astrologerList[index].experienceInYears} Years', style: Get.theme.primaryTextTheme.bodySmall!.copyWith(fontWeight: FontWeight.w300, color: Colors.grey[600])).tr(),
                                        Row(
                                          children: [
                                            Text(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (isLogin) {
                                      ...
                                      if (charge <= global.splashController.currentUser!.walletAmount!) {
                                        ...
                                        global.hideLoader();
                                        Get.to(() => ReportTypeScreen(astrologerId: searchController.astrologerList[index].id!, astrologerName: searchController.astrologerList[index].name!));
                                      } else {
                                        global.showOnlyLoaderDialog(context);
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child:
                                        minBalance != ''
                                            ? Text('Minimum balance ${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} $minBalance is required to get report from $astrologer ', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.red)).tr()
                                            : const SizedBox(),
                                  ),
                                  GestureDetector(
