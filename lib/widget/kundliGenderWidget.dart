                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: CircleAvatar(radius: 35, backgroundColor: kundliController.gender[index].isSelected ? Get.theme.primaryColor : Colors.white, child: Image.asset(kundliController.gender[index].image, height: 70, width: 70)),
                      ),
                    ),
                    Text(kundliController.gender[index].title).tr(),
                  ],
                );
              },
            );
