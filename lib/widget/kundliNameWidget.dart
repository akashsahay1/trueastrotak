        ...
        SizedBox(
          ...
          child: TextButton(
            style: ButtonStyle(
              ...
              backgroundColor: WidgetStateProperty.all(kundliController.isDisable ? Color.fromARGB(255, 209, 204, 204) : Get.theme.primaryColor),
              shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(15), side: BorderSide(color: kundliController.isDisable ? Colors.transparent : Colors.grey))),
            ),
            onPressed: onPressed,
            child: Text('Next', textAlign: TextAlign.center, style: Get.theme.primaryTextTheme.titleMedium!.copyWith(color: kundliController.isDisable ? Color.fromARGB(255, 100, 98, 98) : Colors.white)).tr(),
          ),
        ),
      ],
    );
